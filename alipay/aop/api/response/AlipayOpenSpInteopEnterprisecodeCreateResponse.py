...
class AlipayOpenSpInteopEnterprisecodeCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpInteopEnterprisecodeCreateResponse, self).__init__()
        self._memos = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpInteopEnterprisecodeCreateResponse, self).parse_response_content(response_content)

...
class AlipayOfflineProviderNpassporterBenefitDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOfflineProviderNpassporterBenefitDeleteResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOfflineProviderNpassporterBenefitDeleteResponse, self).parse_response_content(response_content)

...
class AlipayBossProdContractBasicCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdContractBasicCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdContractBasicCancelResponse, self).parse_response_content(response_content)

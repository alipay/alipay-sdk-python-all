...
class AlipayFundWalletRullSetResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundWalletRullSetResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundWalletRullSetResponse, self).parse_response_content(response_content)

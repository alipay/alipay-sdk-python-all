...
class AnttechOceanbaseObglobalLeadsmemberModifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalLeadsmemberModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalLeadsmemberModifyResponse, self).parse_response_content(response_content)

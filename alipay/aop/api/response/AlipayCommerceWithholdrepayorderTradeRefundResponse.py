...
from alipay.aop.api.domain.IndustryRefundChargeInfo import IndustryRefundChargeInfo
...
class AlipayCommerceWithholdrepayorderTradeRefundResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceWithholdrepayorderTradeRefundResponse, self).__init__()
    ...
    def refund_charge_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, IndustryRefundChargeInfo):
                    self._refund_charge_info_list.append(i)
                else:
                    self._refund_charge_info_list.append(IndustryRefundChargeInfo.from_alipay_dict(i))
    @property
        ...
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, IndustryTradeFundBill):
                    ...
                    self._refund_detail_item_list.append(IndustryTradeFundBill.from_alipay_dict(i))
    @property
    def refund_fee(self):
        ...
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, IndustryVoucherDetail):
                    ...
                    self._refund_voucher_detail_list.append(IndustryVoucherDetail.from_alipay_dict(i))
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceWithholdrepayorderTradeRefundResponse, self).parse_response_content(response_content)

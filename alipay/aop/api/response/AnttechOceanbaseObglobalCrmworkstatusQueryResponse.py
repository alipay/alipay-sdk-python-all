...
class AnttechOceanbaseObglobalCrmworkstatusQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalCrmworkstatusQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalCrmworkstatusQueryResponse, self).parse_response_content(response_content)

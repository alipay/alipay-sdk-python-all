...
class AlipayDataDataexchangeSchemainputparamsRainyinoutQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataDataexchangeSchemainputparamsRainyinoutQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataDataexchangeSchemainputparamsRainyinoutQueryResponse, self).parse_response_content(response_content)

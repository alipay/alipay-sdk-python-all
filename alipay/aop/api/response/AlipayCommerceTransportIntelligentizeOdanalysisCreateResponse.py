...
class AlipayCommerceTransportIntelligentizeOdanalysisCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportIntelligentizeOdanalysisCreateResponse, self).__init__()
        self._ext_info = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportIntelligentizeOdanalysisCreateResponse, self).parse_response_content(response_content)

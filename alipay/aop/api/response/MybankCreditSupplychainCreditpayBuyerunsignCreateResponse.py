...
class MybankCreditSupplychainCreditpayBuyerunsignCreateResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditSupplychainCreditpayBuyerunsignCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditSupplychainCreditpayBuyerunsignCreateResponse, self).parse_response_content(response_content)

...
from alipay.aop.api.domain.EpICPRegistrationDataInfo import EpICPRegistrationDataInfo


class ZhimaCreditEpDossierIcpregistrationQueryResponse(AlipayResponse):
    ...
    @data.setter
    def data(self, value):
        if isinstance(value, EpICPRegistrationDataInfo):
            self._data = value
        else:

...
class AlipayBossFncInvoiceAfterdistributeModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncInvoiceAfterdistributeModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncInvoiceAfterdistributeModifyResponse, self).parse_response_content(response_content)

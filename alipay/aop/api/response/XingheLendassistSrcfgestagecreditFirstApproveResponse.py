...
class XingheLendassistSrcfgestagecreditFirstApproveResponse(AlipayResponse):

    def __init__(self):
        super(XingheLendassistSrcfgestagecreditFirstApproveResponse, self).__init__()
        self._apply_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(XingheLendassistSrcfgestagecreditFirstApproveResponse, self).parse_response_content(response_content)
        ...
        if 'pass_type' in response:
            self.pass_type = response['pass_type']

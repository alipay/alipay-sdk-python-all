...
class AlipayOverseasTravelIntlShoplabelSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasTravelIntlShoplabelSyncResponse, self).__init__()
        self._result = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasTravelIntlShoplabelSyncResponse, self).parse_response_content(response_content)

...
class AlipayUserStepcounterNoauthrequiredBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayUserStepcounterNoauthrequiredBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayUserStepcounterNoauthrequiredBatchqueryResponse, self).parse_response_content(response_content)

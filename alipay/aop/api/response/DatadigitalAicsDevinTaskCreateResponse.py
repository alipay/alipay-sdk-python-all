...
class DatadigitalAicsDevinTaskCreateResponse(AlipayResponse):

    def __init__(self):
        super(DatadigitalAicsDevinTaskCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(DatadigitalAicsDevinTaskCreateResponse, self).parse_response_content(response_content)

...
class AlipayCommerceEcServiceOrderBuyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcServiceOrderBuyResponse, self).__init__()
        self._order_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcServiceOrderBuyResponse, self).parse_response_content(response_content)

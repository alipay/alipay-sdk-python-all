...
class AlipayFundAccountbookNotifyUnsubscribeResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundAccountbookNotifyUnsubscribeResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundAccountbookNotifyUnsubscribeResponse, self).parse_response_content(response_content)

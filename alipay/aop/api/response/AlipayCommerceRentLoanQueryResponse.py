...
class AlipayCommerceRentLoanQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceRentLoanQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceRentLoanQueryResponse, self).parse_response_content(response_content)

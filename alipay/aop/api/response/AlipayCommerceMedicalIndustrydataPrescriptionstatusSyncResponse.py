...
class AlipayCommerceMedicalIndustrydataPrescriptionstatusSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalIndustrydataPrescriptionstatusSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalIndustrydataPrescriptionstatusSyncResponse, self).parse_response_content(response_content)

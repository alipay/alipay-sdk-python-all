...
class AnttechOceanbaseObglobalMakecallCreateResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalMakecallCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalMakecallCreateResponse, self).parse_response_content(response_content)

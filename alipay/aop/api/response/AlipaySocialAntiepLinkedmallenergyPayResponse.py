...
class AlipaySocialAntiepLinkedmallenergyPayResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySocialAntiepLinkedmallenergyPayResponse, self).__init__()
        self._biz_desc = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySocialAntiepLinkedmallenergyPayResponse, self).parse_response_content(response_content)

...
class ZhimaCreditEpCreditunionPaSubscribeResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaCreditEpCreditunionPaSubscribeResponse, self).__init__()
        self._biz_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaCreditEpCreditunionPaSubscribeResponse, self).parse_response_content(response_content)

...
class AlipayCommerceMedicalTradeRefundResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalTradeRefundResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalTradeRefundResponse, self).parse_response_content(response_content)

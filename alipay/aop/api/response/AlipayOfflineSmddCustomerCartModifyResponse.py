...
class AlipayOfflineSmddCustomerCartModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOfflineSmddCustomerCartModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOfflineSmddCustomerCartModifyResponse, self).parse_response_content(response_content)

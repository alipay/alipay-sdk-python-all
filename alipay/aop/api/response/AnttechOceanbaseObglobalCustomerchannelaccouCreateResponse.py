...
from alipay.aop.api.domain.FxiaokeCreateCustomerChannelAccountResponse import FxiaokeCreateCustomerChannelAccountResponse


class AnttechOceanbaseObglobalCustomerchannelaccouCreateResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalCustomerchannelaccouCreateResponse, self).__init__()
    ...
    def result(self, value):
        if isinstance(value, FxiaokeCreateCustomerChannelAccountResponse):
            self._result = value
        else:
            self._result = FxiaokeCreateCustomerChannelAccountResponse.from_alipay_dict(value)

    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalCustomerchannelaccouCreateResponse, self).parse_response_content(response_content)

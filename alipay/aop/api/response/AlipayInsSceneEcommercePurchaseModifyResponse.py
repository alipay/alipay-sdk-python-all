...
class AlipayInsSceneEcommercePurchaseModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsSceneEcommercePurchaseModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsSceneEcommercePurchaseModifyResponse, self).parse_response_content(response_content)

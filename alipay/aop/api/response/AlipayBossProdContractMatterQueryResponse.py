...
from alipay.aop.api.domain.OpenApiContractMatterDetailDTO import OpenApiContractMatterDetailDTO


class AlipayBossProdContractMatterQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdContractMatterQueryResponse, self).__init__()
    ...
    def result_data(self, value):
        if isinstance(value, OpenApiContractMatterDetailDTO):
            self._result_data = value
        else:
            self._result_data = OpenApiContractMatterDetailDTO.from_alipay_dict(value)
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdContractMatterQueryResponse, self).parse_response_content(response_content)

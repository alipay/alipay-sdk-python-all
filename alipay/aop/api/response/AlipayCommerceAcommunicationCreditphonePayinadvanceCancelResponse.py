...
class AlipayCommerceAcommunicationCreditphonePayinadvanceCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationCreditphonePayinadvanceCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationCreditphonePayinadvanceCancelResponse, self).parse_response_content(response_content)

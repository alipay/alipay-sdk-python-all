...
class AlipayBossFncArinvoiceRcptamountQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncArinvoiceRcptamountQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncArinvoiceRcptamountQueryResponse, self).parse_response_content(response_content)

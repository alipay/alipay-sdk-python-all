...
class AlipaySecurityRiskMiniprogramPurchaseQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySecurityRiskMiniprogramPurchaseQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySecurityRiskMiniprogramPurchaseQueryResponse, self).parse_response_content(response_content)

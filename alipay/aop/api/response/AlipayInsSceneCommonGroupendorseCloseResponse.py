...
class AlipayInsSceneCommonGroupendorseCloseResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsSceneCommonGroupendorseCloseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsSceneCommonGroupendorseCloseResponse, self).parse_response_content(response_content)

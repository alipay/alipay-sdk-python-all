...
class AnttechOceanbaseChannelUserrateQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseChannelUserrateQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseChannelUserrateQueryResponse, self).parse_response_content(response_content)

...
class MybankCreditUserCertifyOpenQueryResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditUserCertifyOpenQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditUserCertifyOpenQueryResponse, self).parse_response_content(response_content)

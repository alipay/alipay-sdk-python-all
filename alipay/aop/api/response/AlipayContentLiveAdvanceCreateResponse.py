...
class AlipayContentLiveAdvanceCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayContentLiveAdvanceCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayContentLiveAdvanceCreateResponse, self).parse_response_content(response_content)

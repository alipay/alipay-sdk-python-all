...
class AlipayCommerceMedicalInquiryDrugSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalInquiryDrugSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalInquiryDrugSyncResponse, self).parse_response_content(response_content)

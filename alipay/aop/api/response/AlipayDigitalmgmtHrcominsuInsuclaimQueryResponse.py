...
class AlipayDigitalmgmtHrcominsuInsuclaimQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDigitalmgmtHrcominsuInsuclaimQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDigitalmgmtHrcominsuInsuclaimQueryResponse, self).parse_response_content(response_content)

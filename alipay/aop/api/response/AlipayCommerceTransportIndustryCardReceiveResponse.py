...
class AlipayCommerceTransportIndustryCardReceiveResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportIndustryCardReceiveResponse, self).__init__()
        self._card = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportIndustryCardReceiveResponse, self).parse_response_content(response_content)
        if 'card' in response:

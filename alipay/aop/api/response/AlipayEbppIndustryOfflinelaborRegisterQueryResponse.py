...
from alipay.aop.api.domain.OfflineLaborProjectRegistRecord import OfflineLaborProjectRegistRecord


class AlipayEbppIndustryOfflinelaborRegisterQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppIndustryOfflinelaborRegisterQueryResponse, self).__init__()
        self._page_num = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppIndustryOfflinelaborRegisterQueryResponse, self).parse_response_content(response_content)

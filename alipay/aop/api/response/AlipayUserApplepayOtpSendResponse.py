...
class AlipayUserApplepayOtpSendResponse(AlipayResponse):

    def __init__(self):
        super(AlipayUserApplepayOtpSendResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayUserApplepayOtpSendResponse, self).parse_response_content(response_content)

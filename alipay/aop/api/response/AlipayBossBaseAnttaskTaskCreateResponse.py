...
class AlipayBossBaseAnttaskTaskCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossBaseAnttaskTaskCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossBaseAnttaskTaskCreateResponse, self).parse_response_content(response_content)

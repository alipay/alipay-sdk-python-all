...
class AlipayCommerceMedicalHomedoctorOauthCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalHomedoctorOauthCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalHomedoctorOauthCreateResponse, self).parse_response_content(response_content)

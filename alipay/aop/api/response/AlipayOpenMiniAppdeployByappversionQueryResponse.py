...
class AlipayOpenMiniAppdeployByappversionQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenMiniAppdeployByappversionQueryResponse, self).__init__()
        self._deploys = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenMiniAppdeployByappversionQueryResponse, self).parse_response_content(response_content)

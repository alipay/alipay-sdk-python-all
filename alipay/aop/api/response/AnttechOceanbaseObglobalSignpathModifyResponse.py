...
class AnttechOceanbaseObglobalSignpathModifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalSignpathModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalSignpathModifyResponse, self).parse_response_content(response_content)

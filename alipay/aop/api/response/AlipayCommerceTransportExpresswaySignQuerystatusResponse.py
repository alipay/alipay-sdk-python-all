...
class AlipayCommerceTransportExpresswaySignQuerystatusResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportExpresswaySignQuerystatusResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportExpresswaySignQuerystatusResponse, self).parse_response_content(response_content)

...
class AlipayCommerceEcEmployeeInvoiceVerifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcEmployeeInvoiceVerifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcEmployeeInvoiceVerifyResponse, self).parse_response_content(response_content)

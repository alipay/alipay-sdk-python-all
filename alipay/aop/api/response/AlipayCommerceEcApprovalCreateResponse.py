...
class AlipayCommerceEcApprovalCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcApprovalCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcApprovalCreateResponse, self).parse_response_content(response_content)

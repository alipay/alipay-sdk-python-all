...
class AlipayCommerceTransportExpresswayTripQuerystatusResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportExpresswayTripQuerystatusResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportExpresswayTripQuerystatusResponse, self).parse_response_content(response_content)

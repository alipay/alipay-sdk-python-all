...
class AlipayEcoMycarRentcarQuotefilterQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEcoMycarRentcarQuotefilterQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEcoMycarRentcarQuotefilterQueryResponse, self).parse_response_content(response_content)

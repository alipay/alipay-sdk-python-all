...
class AlipayOpenSpNopenModuleUnbindResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpNopenModuleUnbindResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpNopenModuleUnbindResponse, self).parse_response_content(response_content)

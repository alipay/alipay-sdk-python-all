...
from alipay.aop.api.domain.ItemBatchDeleteSuccessInfoDTO import ItemBatchDeleteSuccessInfoDTO


class AlipayCommerceMedicalItemBatchDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalItemBatchDeleteResponse, self).__init__()
    ...
    def succ_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ItemBatchDeleteSuccessInfoDTO):
                    self._succ_list.append(i)
                else:
                    self._succ_list.append(ItemBatchDeleteSuccessInfoDTO.from_alipay_dict(i))

    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalItemBatchDeleteResponse, self).parse_response_content(response_content)

...
class AlipayTradeSubscriptionSubmodeCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeSubscriptionSubmodeCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeSubscriptionSubmodeCreateResponse, self).parse_response_content(response_content)

...
from alipay.aop.api.domain.FxiaokeCreateCustomerResponse import FxiaokeCreateCustomerResponse


class AnttechOceanbaseObglobalCustomerCreateResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalCustomerCreateResponse, self).__init__()
    ...
    def result(self, value):
        if isinstance(value, FxiaokeCreateCustomerResponse):
            self._result = value
        else:
            self._result = FxiaokeCreateCustomerResponse.from_alipay_dict(value)

    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalCustomerCreateResponse, self).parse_response_content(response_content)

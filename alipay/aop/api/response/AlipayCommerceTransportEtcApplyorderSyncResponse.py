...
class AlipayCommerceTransportEtcApplyorderSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportEtcApplyorderSyncResponse, self).__init__()
        self._biz_code = None
        self._biz_msg = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportEtcApplyorderSyncResponse, self).parse_response_content(response_content)

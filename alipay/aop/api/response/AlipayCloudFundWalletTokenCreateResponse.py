...
class AlipayCloudFundWalletTokenCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCloudFundWalletTokenCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCloudFundWalletTokenCreateResponse, self).parse_response_content(response_content)

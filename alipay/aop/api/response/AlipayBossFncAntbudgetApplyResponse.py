...
class AlipayBossFncAntbudgetApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncAntbudgetApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncAntbudgetApplyResponse, self).parse_response_content(response_content)

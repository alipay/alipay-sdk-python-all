...
class AlipayBossProdContractConsultRollbackResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdContractConsultRollbackResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdContractConsultRollbackResponse, self).parse_response_content(response_content)

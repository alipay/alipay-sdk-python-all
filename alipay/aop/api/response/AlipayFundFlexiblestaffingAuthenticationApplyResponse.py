...
class AlipayFundFlexiblestaffingAuthenticationApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundFlexiblestaffingAuthenticationApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundFlexiblestaffingAuthenticationApplyResponse, self).parse_response_content(response_content)

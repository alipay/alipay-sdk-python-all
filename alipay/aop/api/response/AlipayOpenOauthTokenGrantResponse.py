...
class AlipayOpenOauthTokenGrantResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenOauthTokenGrantResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenOauthTokenGrantResponse, self).parse_response_content(response_content)

...
class AlipayIserviceIsresourceSkillgrouppagequeryQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayIserviceIsresourceSkillgrouppagequeryQueryResponse, self).__init__()
        self._biz_data = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayIserviceIsresourceSkillgrouppagequeryQueryResponse, self).parse_response_content(response_content)

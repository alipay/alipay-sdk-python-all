...
class AlipayInsSceneEcommercePreorderquoteRefreshResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsSceneEcommercePreorderquoteRefreshResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsSceneEcommercePreorderquoteRefreshResponse, self).parse_response_content(response_content)

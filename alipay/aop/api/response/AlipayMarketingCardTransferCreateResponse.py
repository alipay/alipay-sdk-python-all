...
class AlipayMarketingCardTransferCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMarketingCardTransferCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMarketingCardTransferCreateResponse, self).parse_response_content(response_content)

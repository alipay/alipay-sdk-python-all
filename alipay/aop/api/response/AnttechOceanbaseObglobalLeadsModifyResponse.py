...
class AnttechOceanbaseObglobalLeadsModifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalLeadsModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalLeadsModifyResponse, self).parse_response_content(response_content)

...
class AlipayPayCodecShareTokenCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPayCodecShareTokenCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPayCodecShareTokenCreateResponse, self).parse_response_content(response_content)

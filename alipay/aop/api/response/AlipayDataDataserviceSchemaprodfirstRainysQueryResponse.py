...
class AlipayDataDataserviceSchemaprodfirstRainysQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataDataserviceSchemaprodfirstRainysQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataDataserviceSchemaprodfirstRainysQueryResponse, self).parse_response_content(response_content)

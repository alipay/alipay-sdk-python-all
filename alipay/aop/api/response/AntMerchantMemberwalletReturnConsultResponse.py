...
class AntMerchantMemberwalletReturnConsultResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantMemberwalletReturnConsultResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantMemberwalletReturnConsultResponse, self).parse_response_content(response_content)

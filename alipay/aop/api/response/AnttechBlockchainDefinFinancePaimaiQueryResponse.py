...
class AnttechBlockchainDefinFinancePaimaiQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinancePaimaiQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinancePaimaiQueryResponse, self).parse_response_content(response_content)

...
class MybankCreditSupplychainCreditpayBuyersignCreateResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditSupplychainCreditpayBuyersignCreateResponse, self).__init__()
        self._ar_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditSupplychainCreditpayBuyersignCreateResponse, self).parse_response_content(response_content)

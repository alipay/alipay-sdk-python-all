...
class ZhimaCreditEpAeprepayContractCloseResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaCreditEpAeprepayContractCloseResponse, self).__init__()
        self._ar_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaCreditEpAeprepayContractCloseResponse, self).parse_response_content(response_content)

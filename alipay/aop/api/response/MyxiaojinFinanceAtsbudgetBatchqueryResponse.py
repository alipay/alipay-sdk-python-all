...
class MyxiaojinFinanceAtsbudgetBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(MyxiaojinFinanceAtsbudgetBatchqueryResponse, self).__init__()
        self._page_num = None
    ...
    def parse_response_content(self, response_content):
        response = super(MyxiaojinFinanceAtsbudgetBatchqueryResponse, self).parse_response_content(response_content)

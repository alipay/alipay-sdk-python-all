...
class TechriskInnovateMpcpromoSceneReleaseResponse(AlipayResponse):

    def __init__(self):
        super(TechriskInnovateMpcpromoSceneReleaseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(TechriskInnovateMpcpromoSceneReleaseResponse, self).parse_response_content(response_content)

...
class AlipayCommerceTransportIntelligentizeOdpredictionCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportIntelligentizeOdpredictionCreateResponse, self).__init__()
        self._ext_info = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportIntelligentizeOdpredictionCreateResponse, self).parse_response_content(response_content)

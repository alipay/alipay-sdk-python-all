...
class MyxiaojinFinanceAtsbudgetReturnResponse(AlipayResponse):

    def __init__(self):
        super(MyxiaojinFinanceAtsbudgetReturnResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MyxiaojinFinanceAtsbudgetReturnResponse, self).parse_response_content(response_content)

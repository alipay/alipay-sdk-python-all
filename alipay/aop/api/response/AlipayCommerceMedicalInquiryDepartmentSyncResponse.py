...
class AlipayCommerceMedicalInquiryDepartmentSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalInquiryDepartmentSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalInquiryDepartmentSyncResponse, self).parse_response_content(response_content)

...
class AlipayOverseasTransferPaymentCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasTransferPaymentCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasTransferPaymentCancelResponse, self).parse_response_content(response_content)

...
class AlipayBossFncInputinvoiceDistributeCallbackResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncInputinvoiceDistributeCallbackResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncInputinvoiceDistributeCallbackResponse, self).parse_response_content(response_content)

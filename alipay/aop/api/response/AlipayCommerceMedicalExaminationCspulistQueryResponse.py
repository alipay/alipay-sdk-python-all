...
class AlipayCommerceMedicalExaminationCspulistQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalExaminationCspulistQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalExaminationCspulistQueryResponse, self).parse_response_content(response_content)

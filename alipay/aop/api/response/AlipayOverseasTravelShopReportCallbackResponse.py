...
class AlipayOverseasTravelShopReportCallbackResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasTravelShopReportCallbackResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasTravelShopReportCallbackResponse, self).parse_response_content(response_content)

...
class AlipayFundFlexiblestaffingContractApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundFlexiblestaffingContractApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundFlexiblestaffingContractApplyResponse, self).parse_response_content(response_content)

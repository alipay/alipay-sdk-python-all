...
class AlipayOpenAppItempromoactivityListModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenAppItempromoactivityListModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenAppItempromoactivityListModifyResponse, self).parse_response_content(response_content)

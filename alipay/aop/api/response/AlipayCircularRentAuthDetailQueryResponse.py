...
from alipay.aop.api.domain.CreditRiskDTO import CreditRiskDTO


class AlipayCircularRentAuthDetailQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCircularRentAuthDetailQueryResponse, self).__init__()
        self._amount = None
        self._auth_no = None
    ...
    def credit_risk_info(self, value):
        if isinstance(value, CreditRiskDTO):
            self._credit_risk_info = value
        else:
            self._credit_risk_info = CreditRiskDTO.from_alipay_dict(value)
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCircularRentAuthDetailQueryResponse, self).parse_response_content(response_content)

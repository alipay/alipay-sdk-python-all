...
class AlipayCommerceTransportChargerZhimaQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportChargerZhimaQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportChargerZhimaQueryResponse, self).parse_response_content(response_content)

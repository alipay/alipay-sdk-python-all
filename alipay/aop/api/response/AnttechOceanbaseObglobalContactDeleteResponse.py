...
class AnttechOceanbaseObglobalContactDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalContactDeleteResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalContactDeleteResponse, self).parse_response_content(response_content)

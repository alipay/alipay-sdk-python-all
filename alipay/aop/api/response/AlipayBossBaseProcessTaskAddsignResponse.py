...
class AlipayBossBaseProcessTaskAddsignResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossBaseProcessTaskAddsignResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossBaseProcessTaskAddsignResponse, self).parse_response_content(response_content)

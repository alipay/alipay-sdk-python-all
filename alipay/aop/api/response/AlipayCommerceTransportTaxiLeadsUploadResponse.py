...
class AlipayCommerceTransportTaxiLeadsUploadResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportTaxiLeadsUploadResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportTaxiLeadsUploadResponse, self).parse_response_content(response_content)

...
class AnttechBlockchainDefinCustomerMappedidQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinCustomerMappedidQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinCustomerMappedidQueryResponse, self).parse_response_content(response_content)

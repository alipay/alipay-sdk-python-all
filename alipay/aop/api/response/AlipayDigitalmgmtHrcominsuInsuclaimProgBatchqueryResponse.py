...
class AlipayDigitalmgmtHrcominsuInsuclaimProgBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDigitalmgmtHrcominsuInsuclaimProgBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDigitalmgmtHrcominsuInsuclaimProgBatchqueryResponse, self).parse_response_content(response_content)

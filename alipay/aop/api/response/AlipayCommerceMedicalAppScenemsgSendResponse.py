...
class AlipayCommerceMedicalAppScenemsgSendResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalAppScenemsgSendResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalAppScenemsgSendResponse, self).parse_response_content(response_content)

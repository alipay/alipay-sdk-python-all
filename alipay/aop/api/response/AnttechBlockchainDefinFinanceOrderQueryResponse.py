...
class AnttechBlockchainDefinFinanceOrderQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinanceOrderQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinanceOrderQueryResponse, self).parse_response_content(response_content)

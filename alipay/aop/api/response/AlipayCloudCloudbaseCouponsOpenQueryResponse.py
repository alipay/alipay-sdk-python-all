...
class AlipayCloudCloudbaseCouponsOpenQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCloudCloudbaseCouponsOpenQueryResponse, self).__init__()
        self._coupons = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCloudCloudbaseCouponsOpenQueryResponse, self).parse_response_content(response_content)

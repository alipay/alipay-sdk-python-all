...
from alipay.aop.api.domain.RefundPaymentAssetInfos import RefundPaymentAssetInfos


class AlipayCloudFundWalletOrderQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCloudFundWalletOrderQueryResponse, self).__init__()
    ...
    def refund_payment_asset_infos(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, RefundPaymentAssetInfos):
                    self._refund_payment_asset_infos.append(i)
                else:
                    self._refund_payment_asset_infos.append(RefundPaymentAssetInfos.from_alipay_dict(i))
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCloudFundWalletOrderQueryResponse, self).parse_response_content(response_content)

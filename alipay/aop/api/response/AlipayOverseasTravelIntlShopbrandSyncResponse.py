...
class AlipayOverseasTravelIntlShopbrandSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasTravelIntlShopbrandSyncResponse, self).__init__()
        self._result = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasTravelIntlShopbrandSyncResponse, self).parse_response_content(response_content)

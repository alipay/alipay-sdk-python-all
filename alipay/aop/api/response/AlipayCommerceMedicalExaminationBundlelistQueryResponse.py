...
class AlipayCommerceMedicalExaminationBundlelistQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalExaminationBundlelistQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalExaminationBundlelistQueryResponse, self).parse_response_content(response_content)

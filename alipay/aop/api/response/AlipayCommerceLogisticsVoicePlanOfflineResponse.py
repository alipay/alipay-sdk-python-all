...
class AlipayCommerceLogisticsVoicePlanOfflineResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceLogisticsVoicePlanOfflineResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceLogisticsVoicePlanOfflineResponse, self).parse_response_content(response_content)

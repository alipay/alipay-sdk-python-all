...
class AlipayCommerceOperationServiceModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceOperationServiceModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceOperationServiceModifyResponse, self).parse_response_content(response_content)

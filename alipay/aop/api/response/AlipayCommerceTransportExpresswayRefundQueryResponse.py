...
class AlipayCommerceTransportExpresswayRefundQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportExpresswayRefundQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportExpresswayRefundQueryResponse, self).parse_response_content(response_content)

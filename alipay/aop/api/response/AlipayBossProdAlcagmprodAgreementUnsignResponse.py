...
class AlipayBossProdAlcagmprodAgreementUnsignResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdAlcagmprodAgreementUnsignResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdAlcagmprodAgreementUnsignResponse, self).parse_response_content(response_content)

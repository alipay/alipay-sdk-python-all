...
class AnttechBlockchainDefinDataserviceOcrSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinDataserviceOcrSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinDataserviceOcrSubmitResponse, self).parse_response_content(response_content)

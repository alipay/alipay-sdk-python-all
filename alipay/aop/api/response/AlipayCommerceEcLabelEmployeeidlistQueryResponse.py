...
class AlipayCommerceEcLabelEmployeeidlistQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcLabelEmployeeidlistQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcLabelEmployeeidlistQueryResponse, self).parse_response_content(response_content)

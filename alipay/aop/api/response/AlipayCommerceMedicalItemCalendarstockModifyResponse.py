...
class AlipayCommerceMedicalItemCalendarstockModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalItemCalendarstockModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalItemCalendarstockModifyResponse, self).parse_response_content(response_content)

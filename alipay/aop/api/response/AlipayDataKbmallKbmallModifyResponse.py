...
class AlipayDataKbmallKbmallModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataKbmallKbmallModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataKbmallKbmallModifyResponse, self).parse_response_content(response_content)

...
class AlipayTradeSubscriptionModifyResponse(AlipayResponse):
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeSubscriptionModifyResponse, self).parse_response_content(response_content)

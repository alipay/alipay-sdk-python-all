...
class AlipayOpenBrandAuthCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenBrandAuthCreateResponse, self).__init__()
        self._brand_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenBrandAuthCreateResponse, self).parse_response_content(response_content)

...
class AlipayBossFncInputinvoiceUncertifyCallbackResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncInputinvoiceUncertifyCallbackResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncInputinvoiceUncertifyCallbackResponse, self).parse_response_content(response_content)

...
class AlipayBossProdContractArchiveSaveResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdContractArchiveSaveResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdContractArchiveSaveResponse, self).parse_response_content(response_content)

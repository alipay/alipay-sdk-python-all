...
class AlipayPcreditHuabeiIsvOpeninfoCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPcreditHuabeiIsvOpeninfoCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPcreditHuabeiIsvOpeninfoCreateResponse, self).parse_response_content(response_content)

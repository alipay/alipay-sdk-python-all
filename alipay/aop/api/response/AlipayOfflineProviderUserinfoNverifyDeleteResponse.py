...
class AlipayOfflineProviderUserinfoNverifyDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOfflineProviderUserinfoNverifyDeleteResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOfflineProviderUserinfoNverifyDeleteResponse, self).parse_response_content(response_content)

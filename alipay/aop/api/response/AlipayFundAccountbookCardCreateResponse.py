...
class AlipayFundAccountbookCardCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundAccountbookCardCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundAccountbookCardCreateResponse, self).parse_response_content(response_content)

...
class AlipayBossProdContractBasicModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdContractBasicModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdContractBasicModifyResponse, self).parse_response_content(response_content)

...
class AlipayCommerceWithholdrepayorderTradeCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceWithholdrepayorderTradeCancelResponse, self).__init__()
        self._action = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceWithholdrepayorderTradeCancelResponse, self).parse_response_content(response_content)

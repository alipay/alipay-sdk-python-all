...
from alipay.aop.api.domain.FxiaokeCreatePartnerResponse import FxiaokeCreatePartnerResponse


class AnttechOceanbaseObglobalPartnerCreateResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalPartnerCreateResponse, self).__init__()
    ...
    def result(self, value):
        if isinstance(value, FxiaokeCreatePartnerResponse):
            self._result = value
        else:
            self._result = FxiaokeCreatePartnerResponse.from_alipay_dict(value)

    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalPartnerCreateResponse, self).parse_response_content(response_content)

...
class AlipayIserviceCstrainingUserdataQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayIserviceCstrainingUserdataQueryResponse, self).__init__()
        self._page_num = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayIserviceCstrainingUserdataQueryResponse, self).parse_response_content(response_content)

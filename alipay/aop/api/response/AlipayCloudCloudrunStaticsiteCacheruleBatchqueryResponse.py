...
class AlipayCloudCloudrunStaticsiteCacheruleBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCloudCloudrunStaticsiteCacheruleBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCloudCloudrunStaticsiteCacheruleBatchqueryResponse, self).parse_response_content(response_content)

...
class MybankCreditSupplychainCreditpaySellersignadmitQueryResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditSupplychainCreditpaySellersignadmitQueryResponse, self).__init__()
        self._admit = None
        self._trace_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditSupplychainCreditpaySellersignadmitQueryResponse, self).parse_response_content(response_content)

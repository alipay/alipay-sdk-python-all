...
class AlipayCommerceAcommunicationPromokernelPrizeRecommendResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationPromokernelPrizeRecommendResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationPromokernelPrizeRecommendResponse, self).parse_response_content(response_content)

...
class AlipayInsUnderwriteSiriusTaskCallbackResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsUnderwriteSiriusTaskCallbackResponse, self).__init__()
        self._biz_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsUnderwriteSiriusTaskCallbackResponse, self).parse_response_content(response_content)

...
class AlipayOverseasRemitWithdrawNotifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasRemitWithdrawNotifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasRemitWithdrawNotifyResponse, self).parse_response_content(response_content)

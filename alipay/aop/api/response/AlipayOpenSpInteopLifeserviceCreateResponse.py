...
class AlipayOpenSpInteopLifeserviceCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpInteopLifeserviceCreateResponse, self).__init__()
        self._memos = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpInteopLifeserviceCreateResponse, self).parse_response_content(response_content)

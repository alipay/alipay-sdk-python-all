...
class AnttechAiCvOcrBusinesslicenseIdentifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechAiCvOcrBusinesslicenseIdentifyResponse, self).__init__()
        self._algo_msg = None
        self._algo_ret = None
        self._message = None
        self._result = None
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechAiCvOcrBusinesslicenseIdentifyResponse, self).parse_response_content(response_content)

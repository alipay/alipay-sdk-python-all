...
class MybankEcnyEntwalletCreateQueryResponse(AlipayResponse):

    def __init__(self):
        super(MybankEcnyEntwalletCreateQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MybankEcnyEntwalletCreateQueryResponse, self).parse_response_content(response_content)

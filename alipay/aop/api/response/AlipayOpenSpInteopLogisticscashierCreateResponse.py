...
class AlipayOpenSpInteopLogisticscashierCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpInteopLogisticscashierCreateResponse, self).__init__()
        self._memos = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpInteopLogisticscashierCreateResponse, self).parse_response_content(response_content)

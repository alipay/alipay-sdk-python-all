...
class AlipayCommerceMedicalHealthcaSignQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalHealthcaSignQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalHealthcaSignQueryResponse, self).parse_response_content(response_content)

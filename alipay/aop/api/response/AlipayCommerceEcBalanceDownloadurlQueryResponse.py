...
class AlipayCommerceEcBalanceDownloadurlQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcBalanceDownloadurlQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcBalanceDownloadurlQueryResponse, self).parse_response_content(response_content)

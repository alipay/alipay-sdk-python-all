...
class AnttechAiAgentServiceConsultResponse(AlipayResponse):

    def __init__(self):
        super(AnttechAiAgentServiceConsultResponse, self).__init__()
        self._answer = None
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechAiAgentServiceConsultResponse, self).parse_response_content(response_content)

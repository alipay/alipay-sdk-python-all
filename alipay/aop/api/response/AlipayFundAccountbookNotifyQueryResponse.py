...
class AlipayFundAccountbookNotifyQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundAccountbookNotifyQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundAccountbookNotifyQueryResponse, self).parse_response_content(response_content)

...
from alipay.aop.api.domain.ObjectKeyWord import ObjectKeyWord


class AlipayIserviceCognitiveClassificationObjectQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayIserviceCognitiveClassificationObjectQueryResponse, self).__init__()
    ...
    def key_words(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ObjectKeyWord):
                    self._key_words.append(i)
                else:
                    self._key_words.append(ObjectKeyWord.from_alipay_dict(i))
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayIserviceCognitiveClassificationObjectQueryResponse, self).parse_response_content(response_content)

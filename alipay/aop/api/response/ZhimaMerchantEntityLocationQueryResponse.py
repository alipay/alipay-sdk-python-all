...
class ZhimaMerchantEntityLocationQueryResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaMerchantEntityLocationQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaMerchantEntityLocationQueryResponse, self).parse_response_content(response_content)

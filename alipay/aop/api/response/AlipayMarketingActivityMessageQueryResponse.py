...
class AlipayMarketingActivityMessageQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMarketingActivityMessageQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMarketingActivityMessageQueryResponse, self).parse_response_content(response_content)

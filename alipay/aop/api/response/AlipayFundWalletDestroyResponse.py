...
class AlipayFundWalletDestroyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundWalletDestroyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundWalletDestroyResponse, self).parse_response_content(response_content)

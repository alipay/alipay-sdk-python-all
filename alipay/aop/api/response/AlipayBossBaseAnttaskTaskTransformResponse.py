...
class AlipayBossBaseAnttaskTaskTransformResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossBaseAnttaskTaskTransformResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossBaseAnttaskTaskTransformResponse, self).parse_response_content(response_content)

...
class AlipayCommerceTransportIntelligentizeWorkshiftCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportIntelligentizeWorkshiftCreateResponse, self).__init__()
        self._ext_info = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportIntelligentizeWorkshiftCreateResponse, self).parse_response_content(response_content)

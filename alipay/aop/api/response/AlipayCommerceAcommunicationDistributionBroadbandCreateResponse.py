...
class AlipayCommerceAcommunicationDistributionBroadbandCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationDistributionBroadbandCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationDistributionBroadbandCreateResponse, self).parse_response_content(response_content)

...
class AlipayCommerceMedicalOrderRefundApproveResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalOrderRefundApproveResponse, self).__init__()
        self._data = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalOrderRefundApproveResponse, self).parse_response_content(response_content)
        if 'data' in response:

...
class AlipayBossFncInputinvoiceOnlineCertifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncInputinvoiceOnlineCertifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncInputinvoiceOnlineCertifyResponse, self).parse_response_content(response_content)

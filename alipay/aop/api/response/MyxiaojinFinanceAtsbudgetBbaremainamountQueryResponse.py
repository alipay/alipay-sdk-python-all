...
class MyxiaojinFinanceAtsbudgetBbaremainamountQueryResponse(AlipayResponse):

    def __init__(self):
        super(MyxiaojinFinanceAtsbudgetBbaremainamountQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(MyxiaojinFinanceAtsbudgetBbaremainamountQueryResponse, self).parse_response_content(response_content)

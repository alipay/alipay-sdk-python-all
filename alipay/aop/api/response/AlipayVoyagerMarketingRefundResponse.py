...
class AlipayVoyagerMarketingRefundResponse(AlipayResponse):

    def __init__(self):
        super(AlipayVoyagerMarketingRefundResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayVoyagerMarketingRefundResponse, self).parse_response_content(response_content)

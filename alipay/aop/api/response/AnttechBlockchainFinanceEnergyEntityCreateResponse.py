...
class AnttechBlockchainFinanceEnergyEntityCreateResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainFinanceEnergyEntityCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainFinanceEnergyEntityCreateResponse, self).parse_response_content(response_content)

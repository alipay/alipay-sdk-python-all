...
class ZhimaMerchantContractCommonQueryResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaMerchantContractCommonQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaMerchantContractCommonQueryResponse, self).parse_response_content(response_content)
        ...
        if 'gmt_valid' in response:
            self.gmt_valid = response['gmt_valid']

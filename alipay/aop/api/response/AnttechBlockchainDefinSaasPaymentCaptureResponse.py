...
class AnttechBlockchainDefinSaasPaymentCaptureResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinSaasPaymentCaptureResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinSaasPaymentCaptureResponse, self).parse_response_content(response_content)

...
class MybankCreditSupplychainCreditpaySellerunsignQueryResponse(AlipayResponse):

    def __init__(self):
        super(MybankCreditSupplychainCreditpaySellerunsignQueryResponse, self).__init__()
        self._admit = None
        self._trace_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(MybankCreditSupplychainCreditpaySellerunsignQueryResponse, self).parse_response_content(response_content)

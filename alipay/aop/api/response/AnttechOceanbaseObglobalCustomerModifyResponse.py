...
class AnttechOceanbaseObglobalCustomerModifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalCustomerModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalCustomerModifyResponse, self).parse_response_content(response_content)

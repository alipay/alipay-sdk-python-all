...
from alipay.aop.api.domain.NxActivityVoucherInfo import NxActivityVoucherInfo


class AlipayCommerceNxactivityQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceNxactivityQueryResponse, self).__init__()
    ...
    def voucher_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, NxActivityVoucherInfo):
                    self._voucher_list.append(i)
                else:
                    self._voucher_list.append(NxActivityVoucherInfo.from_alipay_dict(i))

    def parse_response_content(self, response_content):
        response = super(AlipayCommerceNxactivityQueryResponse, self).parse_response_content(response_content)

...
from alipay.aop.api.domain.OpenApiContractInfoDTO import OpenApiContractInfoDTO


class AlipayBossProdContractDetailCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdContractDetailCreateResponse, self).__init__()
    ...
    def result_data(self, value):
        if isinstance(value, OpenApiContractInfoDTO):
            self._result_data = value
        else:
            self._result_data = OpenApiContractInfoDTO.from_alipay_dict(value)
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdContractDetailCreateResponse, self).parse_response_content(response_content)

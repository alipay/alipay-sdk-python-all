...
class AlipayPcreditLoanSideloanlendLendApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPcreditLoanSideloanlendLendApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPcreditLoanSideloanlendLendApplyResponse, self).parse_response_content(response_content)

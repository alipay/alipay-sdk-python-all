...
class AlipayCommerceMedicalInquiryDoctorUploadResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalInquiryDoctorUploadResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalInquiryDoctorUploadResponse, self).parse_response_content(response_content)

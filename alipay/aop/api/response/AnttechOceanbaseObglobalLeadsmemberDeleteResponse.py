...
class AnttechOceanbaseObglobalLeadsmemberDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalLeadsmemberDeleteResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalLeadsmemberDeleteResponse, self).parse_response_content(response_content)

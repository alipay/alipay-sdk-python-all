...
class AlipayBossBaseAnttaskTaskRestartResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossBaseAnttaskTaskRestartResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossBaseAnttaskTaskRestartResponse, self).parse_response_content(response_content)

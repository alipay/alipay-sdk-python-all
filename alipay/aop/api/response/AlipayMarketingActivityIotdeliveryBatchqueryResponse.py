...
class AlipayMarketingActivityIotdeliveryBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayMarketingActivityIotdeliveryBatchqueryResponse, self).__init__()
    ...
    def plan_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, IoTDeliveryPlan):
                    self._plan_list.append(i)
                else:
                    self._plan_list.append(IoTDeliveryPlan.from_alipay_dict(i))
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayMarketingActivityIotdeliveryBatchqueryResponse, self).parse_response_content(response_content)

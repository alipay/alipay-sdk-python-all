...
from alipay.aop.api.domain.IndustryBkAgentRespInfo import IndustryBkAgentRespInfo
from alipay.aop.api.domain.IndustryChargeInfo import IndustryChargeInfo
from alipay.aop.api.domain.EnterprisePayInfo import EnterprisePayInfo
from alipay.aop.api.domain.IndustryFulfillmentDetail import IndustryFulfillmentDetail
from alipay.aop.api.domain.IndustryTradeFundBill import IndustryTradeFundBill
from alipay.aop.api.domain.IndustryHbFqPayInfo import IndustryHbFqPayInfo
from alipay.aop.api.domain.IndustryIntactChargeInfo import IndustryIntactChargeInfo
from alipay.aop.api.domain.IndustryPaymentInfoWithId import IndustryPaymentInfoWithId
from alipay.aop.api.domain.GoodsDetail import GoodsDetail
from alipay.aop.api.domain.IndustryTradeSettleInfo import IndustryTradeSettleInfo
from alipay.aop.api.domain.IndustryVoucherDetail import IndustryVoucherDetail


class AlipayCommerceWithholdrepayorderTradeQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceWithholdrepayorderTradeQueryResponse, self).__init__()
    ...
    def bkagent_resp_info(self, value):
        if isinstance(value, IndustryBkAgentRespInfo):
            self._bkagent_resp_info = value
        else:
            self._bkagent_resp_info = IndustryBkAgentRespInfo.from_alipay_dict(value)
    @property
    def body(self):
        return self._body
    ...
    def charge_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, IndustryChargeInfo):
                    self._charge_info_list.append(i)
                else:
                    self._charge_info_list.append(IndustryChargeInfo.from_alipay_dict(i))
    @property
    ...
    def fulfillment_detail_list(self, value):
        if isinstance(value, IndustryFulfillmentDetail):
            self._fulfillment_detail_list = value
        else:
            self._fulfillment_detail_list = IndustryFulfillmentDetail.from_alipay_dict(value)
    @property
    ...
    def fund_bill_list(self, value):
        if isinstance(value, IndustryTradeFundBill):
            self._fund_bill_list = value
        else:
            self._fund_bill_list = IndustryTradeFundBill.from_alipay_dict(value)
    @property
    ...
    def hb_fq_pay_info(self, value):
        if isinstance(value, IndustryHbFqPayInfo):
            self._hb_fq_pay_info = value
        else:
            self._hb_fq_pay_info = IndustryHbFqPayInfo.from_alipay_dict(value)
    @property
    def hyb_amount(self):
    ...
    def intact_charge_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, IndustryIntactChargeInfo):
                    self._intact_charge_info_list.append(i)
                else:
                    self._intact_charge_info_list.append(IndustryIntactChargeInfo.from_alipay_dict(i))
    @property
    ...
    def payment_info_with_id_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, IndustryPaymentInfoWithId):
                    self._payment_info_with_id_list.append(i)
                else:
                    self._payment_info_with_id_list.append(IndustryPaymentInfoWithId.from_alipay_dict(i))
    @property
    ...
    def trade_settle_info(self, value):
        if isinstance(value, IndustryTradeSettleInfo):
            self._trade_settle_info = value
        else:
            self._trade_settle_info = IndustryTradeSettleInfo.from_alipay_dict(value)
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceWithholdrepayorderTradeQueryResponse, self).parse_response_content(response_content)

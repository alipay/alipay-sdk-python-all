...
class ZhimaCreditEpAssistantCbumemberpackageCreateResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaCreditEpAssistantCbumemberpackageCreateResponse, self).__init__()
    ...
    def license_detail_list(self, value):
        if isinstance(value, AssistantLicenseInfo):
            self._license_detail_list = value
        else:
            self._license_detail_list = AssistantLicenseInfo.from_alipay_dict(value)
    @property
    def licenses(self):
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaCreditEpAssistantCbumemberpackageCreateResponse, self).parse_response_content(response_content)

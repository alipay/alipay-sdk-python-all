...
class AntMerchantExpandTerminateConsultresultSyncResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandTerminateConsultresultSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandTerminateConsultresultSyncResponse, self).parse_response_content(response_content)

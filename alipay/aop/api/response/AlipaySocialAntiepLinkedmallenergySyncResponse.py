...
class AlipaySocialAntiepLinkedmallenergySyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySocialAntiepLinkedmallenergySyncResponse, self).__init__()
        self._biz_desc = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySocialAntiepLinkedmallenergySyncResponse, self).parse_response_content(response_content)

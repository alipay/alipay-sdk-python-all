...
class AnttechBlockchainDefinAssetmanagePenetrateSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinAssetmanagePenetrateSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinAssetmanagePenetrateSubmitResponse, self).parse_response_content(response_content)

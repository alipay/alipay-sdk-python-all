...
class DatadigitalFincloudGeneralsaasOcrServerDetectResponse(AlipayResponse):

    def __init__(self):
        super(DatadigitalFincloudGeneralsaasOcrServerDetectResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(DatadigitalFincloudGeneralsaasOcrServerDetectResponse, self).parse_response_content(response_content)

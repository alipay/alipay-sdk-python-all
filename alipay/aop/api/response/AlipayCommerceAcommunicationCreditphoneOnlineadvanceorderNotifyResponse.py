...
class AlipayCommerceAcommunicationCreditphoneOnlineadvanceorderNotifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationCreditphoneOnlineadvanceorderNotifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationCreditphoneOnlineadvanceorderNotifyResponse, self).parse_response_content(response_content)

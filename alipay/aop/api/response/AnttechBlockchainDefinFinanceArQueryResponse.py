...
class AnttechBlockchainDefinFinanceArQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinanceArQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinanceArQueryResponse, self).parse_response_content(response_content)

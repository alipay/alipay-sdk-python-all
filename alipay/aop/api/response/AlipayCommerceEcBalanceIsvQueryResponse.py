...
class AlipayCommerceEcBalanceIsvQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcBalanceIsvQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcBalanceIsvQueryResponse, self).parse_response_content(response_content)

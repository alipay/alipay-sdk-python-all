...
class AnttechBlockchainDefinFinanceOrderSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinanceOrderSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinanceOrderSubmitResponse, self).parse_response_content(response_content)

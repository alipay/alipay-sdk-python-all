...
class AlipayCommerceOperationServiceApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceOperationServiceApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceOperationServiceApplyResponse, self).parse_response_content(response_content)

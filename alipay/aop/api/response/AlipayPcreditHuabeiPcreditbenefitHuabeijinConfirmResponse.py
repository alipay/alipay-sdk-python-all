...
class AlipayPcreditHuabeiPcreditbenefitHuabeijinConfirmResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPcreditHuabeiPcreditbenefitHuabeijinConfirmResponse, self).__init__()
        self._activated_amount = None
    ...
    @property
    def activated_amount(self):
        return self._activated_amount

    @activated_amount.setter
    def activated_amount(self, value):
        self._activated_amount = value
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPcreditHuabeiPcreditbenefitHuabeijinConfirmResponse, self).parse_response_content(response_content)
        if 'activated_amount' in response:
            self.activated_amount = response['activated_amount']

...
class AlipayCommerceMedicalOrgbidataBlockinfoQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalOrgbidataBlockinfoQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalOrgbidataBlockinfoQueryResponse, self).parse_response_content(response_content)

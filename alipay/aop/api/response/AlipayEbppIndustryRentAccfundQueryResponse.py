...
class AlipayEbppIndustryRentAccfundQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppIndustryRentAccfundQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppIndustryRentAccfundQueryResponse, self).parse_response_content(response_content)

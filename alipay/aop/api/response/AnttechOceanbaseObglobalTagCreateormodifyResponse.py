...
class AnttechOceanbaseObglobalTagCreateormodifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalTagCreateormodifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalTagCreateormodifyResponse, self).parse_response_content(response_content)

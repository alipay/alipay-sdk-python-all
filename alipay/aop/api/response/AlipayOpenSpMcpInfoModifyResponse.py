...
class AlipayOpenSpMcpInfoModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpMcpInfoModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpMcpInfoModifyResponse, self).parse_response_content(response_content)

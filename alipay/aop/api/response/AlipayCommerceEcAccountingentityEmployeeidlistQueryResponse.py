...
class AlipayCommerceEcAccountingentityEmployeeidlistQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcAccountingentityEmployeeidlistQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcAccountingentityEmployeeidlistQueryResponse, self).parse_response_content(response_content)

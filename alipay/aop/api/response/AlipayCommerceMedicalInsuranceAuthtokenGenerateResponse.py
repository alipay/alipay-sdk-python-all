...
class AlipayCommerceMedicalInsuranceAuthtokenGenerateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalInsuranceAuthtokenGenerateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalInsuranceAuthtokenGenerateResponse, self).parse_response_content(response_content)

...
class AlipayCloudFundWalletDestroyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCloudFundWalletDestroyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCloudFundWalletDestroyResponse, self).parse_response_content(response_content)

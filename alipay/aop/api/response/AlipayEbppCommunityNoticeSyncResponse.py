...
class AlipayEbppCommunityNoticeSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppCommunityNoticeSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppCommunityNoticeSyncResponse, self).parse_response_content(response_content)

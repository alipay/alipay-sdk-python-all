...
class ZhimaCreditEpContactinfoExtQueryResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaCreditEpContactinfoExtQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaCreditEpContactinfoExtQueryResponse, self).parse_response_content(response_content)

...
class AnttechOceanbaseObglobalPartnerModifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalPartnerModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalPartnerModifyResponse, self).parse_response_content(response_content)

...
class AlipayCommerceMedicalDirectTradeRefundResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalDirectTradeRefundResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalDirectTradeRefundResponse, self).parse_response_content(response_content)

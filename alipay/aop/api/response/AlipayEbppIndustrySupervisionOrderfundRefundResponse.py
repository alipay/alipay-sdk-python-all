...
class AlipayEbppIndustrySupervisionOrderfundRefundResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppIndustrySupervisionOrderfundRefundResponse, self).__init__()
        self._amount = None
        self._currency = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppIndustrySupervisionOrderfundRefundResponse, self).parse_response_content(response_content)

...
class AlipayOpenAppServicePromoApplyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenAppServicePromoApplyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenAppServicePromoApplyResponse, self).parse_response_content(response_content)

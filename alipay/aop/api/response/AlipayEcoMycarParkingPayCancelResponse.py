...
class AlipayEcoMycarParkingPayCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEcoMycarParkingPayCancelResponse, self).__init__()
        self._biz_code = None
        self._biz_msg = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEcoMycarParkingPayCancelResponse, self).parse_response_content(response_content)

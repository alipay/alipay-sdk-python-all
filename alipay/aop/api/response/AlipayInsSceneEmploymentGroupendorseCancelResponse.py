...
class AlipayInsSceneEmploymentGroupendorseCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsSceneEmploymentGroupendorseCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsSceneEmploymentGroupendorseCancelResponse, self).parse_response_content(response_content)

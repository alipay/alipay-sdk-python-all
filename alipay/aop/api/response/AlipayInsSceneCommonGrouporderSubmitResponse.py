...
class AlipayInsSceneCommonGrouporderSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsSceneCommonGrouporderSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsSceneCommonGrouporderSubmitResponse, self).parse_response_content(response_content)

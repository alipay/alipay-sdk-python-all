...
class ZhimaMerchantCreditserviceCreateResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaMerchantCreditserviceCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaMerchantCreditserviceCreateResponse, self).parse_response_content(response_content)

...
from alipay.aop.api.domain.AosHotItem import AosHotItem


class AlipayOpenMiniCloudAoshotQueryResponse(AlipayResponse):
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenMiniCloudAoshotQueryResponse, self).parse_response_content(response_content)

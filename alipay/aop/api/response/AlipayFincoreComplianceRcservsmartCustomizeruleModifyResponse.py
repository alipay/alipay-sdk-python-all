...
class AlipayFincoreComplianceRcservsmartCustomizeruleModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFincoreComplianceRcservsmartCustomizeruleModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFincoreComplianceRcservsmartCustomizeruleModifyResponse, self).parse_response_content(response_content)

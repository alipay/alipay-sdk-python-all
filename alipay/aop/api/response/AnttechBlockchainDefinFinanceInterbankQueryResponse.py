...
class AnttechBlockchainDefinFinanceInterbankQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinanceInterbankQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinanceInterbankQueryResponse, self).parse_response_content(response_content)

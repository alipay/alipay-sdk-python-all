...
class AnttechOceanbaseObglobalCustomerchannelaccouModifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalCustomerchannelaccouModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalCustomerchannelaccouModifyResponse, self).parse_response_content(response_content)

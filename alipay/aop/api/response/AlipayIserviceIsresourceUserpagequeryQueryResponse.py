...
class AlipayIserviceIsresourceUserpagequeryQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayIserviceIsresourceUserpagequeryQueryResponse, self).__init__()
        self._biz_data = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayIserviceIsresourceUserpagequeryQueryResponse, self).parse_response_content(response_content)

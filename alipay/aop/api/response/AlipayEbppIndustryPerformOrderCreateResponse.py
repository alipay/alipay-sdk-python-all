...
class AlipayEbppIndustryPerformOrderCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayEbppIndustryPerformOrderCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayEbppIndustryPerformOrderCreateResponse, self).parse_response_content(response_content)

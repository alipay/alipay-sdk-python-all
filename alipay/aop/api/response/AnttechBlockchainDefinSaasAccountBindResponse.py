...
class AnttechBlockchainDefinSaasAccountBindResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinSaasAccountBindResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinSaasAccountBindResponse, self).parse_response_content(response_content)

...
class AntMerchantExpandLogisticUploadSyncResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandLogisticUploadSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandLogisticUploadSyncResponse, self).parse_response_content(response_content)

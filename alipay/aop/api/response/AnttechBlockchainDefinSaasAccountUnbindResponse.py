...
class AnttechBlockchainDefinSaasAccountUnbindResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinSaasAccountUnbindResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinSaasAccountUnbindResponse, self).parse_response_content(response_content)

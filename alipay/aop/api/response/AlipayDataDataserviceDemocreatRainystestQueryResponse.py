...
class AlipayDataDataserviceDemocreatRainystestQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayDataDataserviceDemocreatRainystestQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayDataDataserviceDemocreatRainystestQueryResponse, self).parse_response_content(response_content)

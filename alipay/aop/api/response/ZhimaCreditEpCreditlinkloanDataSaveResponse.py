...
class ZhimaCreditEpCreditlinkloanDataSaveResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaCreditEpCreditlinkloanDataSaveResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaCreditEpCreditlinkloanDataSaveResponse, self).parse_response_content(response_content)

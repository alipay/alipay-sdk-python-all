...
class AlipayCommerceAcommunicationPhoneOrderPayResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationPhoneOrderPayResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationPhoneOrderPayResponse, self).parse_response_content(response_content)

...
class AlipayPcreditHuabeiPcreditbenefitHuabeijinModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPcreditHuabeiPcreditbenefitHuabeijinModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPcreditHuabeiPcreditbenefitHuabeijinModifyResponse, self).parse_response_content(response_content)

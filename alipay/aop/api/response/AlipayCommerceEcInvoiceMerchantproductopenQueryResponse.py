...
class AlipayCommerceEcInvoiceMerchantproductopenQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcInvoiceMerchantproductopenQueryResponse, self).__init__()
        self._apply_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcInvoiceMerchantproductopenQueryResponse, self).parse_response_content(response_content)

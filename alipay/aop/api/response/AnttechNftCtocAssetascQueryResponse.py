...
class AnttechNftCtocAssetascQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechNftCtocAssetascQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechNftCtocAssetascQueryResponse, self).parse_response_content(response_content)

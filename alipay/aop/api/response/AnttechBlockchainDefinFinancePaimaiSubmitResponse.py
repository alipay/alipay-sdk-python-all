...
class AnttechBlockchainDefinFinancePaimaiSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinancePaimaiSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinancePaimaiSubmitResponse, self).parse_response_content(response_content)

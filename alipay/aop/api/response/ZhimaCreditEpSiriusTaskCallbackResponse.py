...
class ZhimaCreditEpSiriusTaskCallbackResponse(AlipayResponse):

    def __init__(self):
        super(ZhimaCreditEpSiriusTaskCallbackResponse, self).__init__()
        self._biz_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(ZhimaCreditEpSiriusTaskCallbackResponse, self).parse_response_content(response_content)

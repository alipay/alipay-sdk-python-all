...
class AntPcinstpromoPcinstpromoChannelvoucherSendResponse(AlipayResponse):

    def __init__(self):
        super(AntPcinstpromoPcinstpromoChannelvoucherSendResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntPcinstpromoPcinstpromoChannelvoucherSendResponse, self).parse_response_content(response_content)

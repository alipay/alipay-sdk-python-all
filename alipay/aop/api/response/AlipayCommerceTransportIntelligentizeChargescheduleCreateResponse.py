...
class AlipayCommerceTransportIntelligentizeChargescheduleCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportIntelligentizeChargescheduleCreateResponse, self).__init__()
        self._ext_info = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportIntelligentizeChargescheduleCreateResponse, self).parse_response_content(response_content)

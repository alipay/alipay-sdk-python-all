...
class DatadigitalFincloudGeneralsaasOcrLlmDetectResponse(AlipayResponse):

    def __init__(self):
        super(DatadigitalFincloudGeneralsaasOcrLlmDetectResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(DatadigitalFincloudGeneralsaasOcrLlmDetectResponse, self).parse_response_content(response_content)

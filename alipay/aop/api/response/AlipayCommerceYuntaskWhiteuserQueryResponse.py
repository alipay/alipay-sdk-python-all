...
class AlipayCommerceYuntaskWhiteuserQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceYuntaskWhiteuserQueryResponse, self).__init__()
        self._page = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceYuntaskWhiteuserQueryResponse, self).parse_response_content(response_content)
        if 'page' in response:

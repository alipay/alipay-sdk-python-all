...
class AlipaySecurityRiskMarketingAwardingQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySecurityRiskMarketingAwardingQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySecurityRiskMarketingAwardingQueryResponse, self).parse_response_content(response_content)

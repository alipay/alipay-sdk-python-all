...
class AlipayOfflineProviderCollaborateTaskConfirmResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOfflineProviderCollaborateTaskConfirmResponse, self).__init__()
        self._task = None
        self._task_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOfflineProviderCollaborateTaskConfirmResponse, self).parse_response_content(response_content)
        if 'task' in response:

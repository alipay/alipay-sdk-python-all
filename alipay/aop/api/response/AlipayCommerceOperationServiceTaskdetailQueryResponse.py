...
class AlipayCommerceOperationServiceTaskdetailQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceOperationServiceTaskdetailQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceOperationServiceTaskdetailQueryResponse, self).parse_response_content(response_content)

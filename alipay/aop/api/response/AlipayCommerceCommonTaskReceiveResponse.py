...
class AlipayCommerceCommonTaskReceiveResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceCommonTaskReceiveResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceCommonTaskReceiveResponse, self).parse_response_content(response_content)

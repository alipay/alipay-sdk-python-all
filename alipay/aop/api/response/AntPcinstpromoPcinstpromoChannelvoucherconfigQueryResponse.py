...
from alipay.aop.api.domain.BenefitSendTimeInfo import BenefitSendTimeInfo
from alipay.aop.api.domain.CouponEffectTimeInfo import CouponEffectTimeInfo
from alipay.aop.api.domain.CouponTemplateConsume import CouponTemplateConsume
from alipay.aop.api.domain.DiscountInfoConfigInfo import DiscountInfoConfigInfo


class AntPcinstpromoPcinstpromoChannelvoucherconfigQueryResponse(AlipayResponse):

    def __init__(self):
        super(AntPcinstpromoPcinstpromoChannelvoucherconfigQueryResponse, self).__init__()
    ...
    def benefit_send_time(self, value):
        if isinstance(value, BenefitSendTimeInfo):
            self._benefit_send_time = value
        else:
            self._benefit_send_time = BenefitSendTimeInfo.from_alipay_dict(value)
    @property
    ...
    def coupon_effect_time(self, value):
        if isinstance(value, CouponEffectTimeInfo):
            self._coupon_effect_time = value
        else:
            self._coupon_effect_time = CouponEffectTimeInfo.from_alipay_dict(value)
    @property
    ...
    def coupon_template_consume_info(self, value):
        if isinstance(value, CouponTemplateConsume):
            self._coupon_template_consume_info = value
        else:
            self._coupon_template_consume_info = CouponTemplateConsume.from_alipay_dict(value)
    @property
    ...
    def discount_info_config(self, value):
        if isinstance(value, DiscountInfoConfigInfo):
            self._discount_info_config = value
        else:
            self._discount_info_config = DiscountInfoConfigInfo.from_alipay_dict(value)
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(AntPcinstpromoPcinstpromoChannelvoucherconfigQueryResponse, self).parse_response_content(response_content)

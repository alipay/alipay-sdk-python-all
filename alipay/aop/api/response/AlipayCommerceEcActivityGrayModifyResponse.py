...
class AlipayCommerceEcActivityGrayModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceEcActivityGrayModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceEcActivityGrayModifyResponse, self).parse_response_content(response_content)

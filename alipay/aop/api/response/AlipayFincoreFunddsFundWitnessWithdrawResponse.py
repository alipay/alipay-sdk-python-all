...
class AlipayFincoreFunddsFundWitnessWithdrawResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFincoreFunddsFundWitnessWithdrawResponse, self).__init__()
        self._fds_no = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFincoreFunddsFundWitnessWithdrawResponse, self).parse_response_content(response_content)

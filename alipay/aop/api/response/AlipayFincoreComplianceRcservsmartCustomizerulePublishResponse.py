...
class AlipayFincoreComplianceRcservsmartCustomizerulePublishResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFincoreComplianceRcservsmartCustomizerulePublishResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFincoreComplianceRcservsmartCustomizerulePublishResponse, self).parse_response_content(response_content)

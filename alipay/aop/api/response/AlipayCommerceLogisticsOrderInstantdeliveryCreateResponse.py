...
class AlipayCommerceLogisticsOrderInstantdeliveryCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceLogisticsOrderInstantdeliveryCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceLogisticsOrderInstantdeliveryCreateResponse, self).parse_response_content(response_content)

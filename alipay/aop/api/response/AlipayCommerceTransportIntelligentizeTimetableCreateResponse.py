...
class AlipayCommerceTransportIntelligentizeTimetableCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportIntelligentizeTimetableCreateResponse, self).__init__()
        self._ext_info = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportIntelligentizeTimetableCreateResponse, self).parse_response_content(response_content)

...
class AlipayCommerceAcommunicationCreditphonePeriodorderCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationCreditphonePeriodorderCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationCreditphonePeriodorderCancelResponse, self).parse_response_content(response_content)

...
class AnttechBlockchainDefinFinanceArSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinanceArSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinanceArSubmitResponse, self).parse_response_content(response_content)

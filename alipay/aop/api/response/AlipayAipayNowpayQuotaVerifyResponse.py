...
class AlipayAipayNowpayQuotaVerifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayAipayNowpayQuotaVerifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayAipayNowpayQuotaVerifyResponse, self).parse_response_content(response_content)

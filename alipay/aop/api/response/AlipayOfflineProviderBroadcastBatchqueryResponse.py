...
class AlipayOfflineProviderBroadcastBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOfflineProviderBroadcastBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOfflineProviderBroadcastBatchqueryResponse, self).parse_response_content(response_content)

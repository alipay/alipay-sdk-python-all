...
class AlipayCommerceTransportExpresswayTripRefundResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportExpresswayTripRefundResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportExpresswayTripRefundResponse, self).parse_response_content(response_content)

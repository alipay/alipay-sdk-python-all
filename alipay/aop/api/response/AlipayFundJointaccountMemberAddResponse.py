...
class AlipayFundJointaccountMemberAddResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundJointaccountMemberAddResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundJointaccountMemberAddResponse, self).parse_response_content(response_content)

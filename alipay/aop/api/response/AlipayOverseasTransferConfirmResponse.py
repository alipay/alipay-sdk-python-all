...
class AlipayOverseasTransferConfirmResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasTransferConfirmResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasTransferConfirmResponse, self).parse_response_content(response_content)

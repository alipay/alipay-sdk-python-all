...
class AnttechBlockchainDefinTradeQueryResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinTradeQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinTradeQueryResponse, self).parse_response_content(response_content)

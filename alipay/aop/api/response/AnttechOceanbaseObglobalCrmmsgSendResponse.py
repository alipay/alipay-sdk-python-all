...
class AnttechOceanbaseObglobalCrmmsgSendResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalCrmmsgSendResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalCrmmsgSendResponse, self).parse_response_content(response_content)

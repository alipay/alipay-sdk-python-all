...
class AlipayTradeScenepaySharecodetestCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeScenepaySharecodetestCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeScenepaySharecodetestCreateResponse, self).parse_response_content(response_content)

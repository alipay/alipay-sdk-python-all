...
class AlipayFundAccountbookCloseResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundAccountbookCloseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundAccountbookCloseResponse, self).parse_response_content(response_content)

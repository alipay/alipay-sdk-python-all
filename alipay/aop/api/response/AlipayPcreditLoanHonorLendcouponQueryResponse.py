...
class AlipayPcreditLoanHonorLendcouponQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayPcreditLoanHonorLendcouponQueryResponse, self).__init__()
        self._records = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayPcreditLoanHonorLendcouponQueryResponse, self).parse_response_content(response_content)

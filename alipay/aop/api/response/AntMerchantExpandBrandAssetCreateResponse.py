...
class AntMerchantExpandBrandAssetCreateResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandBrandAssetCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandBrandAssetCreateResponse, self).parse_response_content(response_content)

...
class AlipayOpenOauthTokenRefreshResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenOauthTokenRefreshResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenOauthTokenRefreshResponse, self).parse_response_content(response_content)

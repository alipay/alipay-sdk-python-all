...
class AlipayOpenAppItemDirectModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenAppItemDirectModifyResponse, self).__init__()
        self._item_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenAppItemDirectModifyResponse, self).parse_response_content(response_content)

...
class AlipayCloudFundWalletRefundResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCloudFundWalletRefundResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCloudFundWalletRefundResponse, self).parse_response_content(response_content)

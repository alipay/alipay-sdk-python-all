...
class AlipayInsSceneEcommercePurchaseCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsSceneEcommercePurchaseCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsSceneEcommercePurchaseCancelResponse, self).parse_response_content(response_content)

...
class AlipayCommerceTransportTourAssetDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportTourAssetDeleteResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportTourAssetDeleteResponse, self).parse_response_content(response_content)

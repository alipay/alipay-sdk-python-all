...
class AlipayCommerceMedicalPromoOrderSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalPromoOrderSyncResponse, self).__init__()
        self._res_code = None
        self._res_flag = None
        self._res_msg = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalPromoOrderSyncResponse, self).parse_response_content(response_content)

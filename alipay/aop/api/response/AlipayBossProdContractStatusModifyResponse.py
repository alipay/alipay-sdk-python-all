...
class AlipayBossProdContractStatusModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossProdContractStatusModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossProdContractStatusModifyResponse, self).parse_response_content(response_content)

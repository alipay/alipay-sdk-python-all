...
class AlipayContentCommercialStoreitemBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayContentCommercialStoreitemBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayContentCommercialStoreitemBatchqueryResponse, self).parse_response_content(response_content)

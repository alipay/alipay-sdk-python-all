...
class AlipayUserApplepayProvisioningbundleModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayUserApplepayProvisioningbundleModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayUserApplepayProvisioningbundleModifyResponse, self).parse_response_content(response_content)

...
class AlipayCommerceTransportExpresswayTripCreateandpayResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportExpresswayTripCreateandpayResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportExpresswayTripCreateandpayResponse, self).parse_response_content(response_content)

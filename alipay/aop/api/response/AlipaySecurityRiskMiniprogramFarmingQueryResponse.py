...
class AlipaySecurityRiskMiniprogramFarmingQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySecurityRiskMiniprogramFarmingQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySecurityRiskMiniprogramFarmingQueryResponse, self).parse_response_content(response_content)

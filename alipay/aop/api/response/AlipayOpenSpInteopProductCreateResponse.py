...
class AlipayOpenSpInteopProductCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpInteopProductCreateResponse, self).__init__()
        self._memos = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpInteopProductCreateResponse, self).parse_response_content(response_content)

...
class AlipayOpenSpNordermaterialsapplyMaterialsrecordSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpNordermaterialsapplyMaterialsrecordSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpNordermaterialsapplyMaterialsrecordSyncResponse, self).parse_response_content(response_content)

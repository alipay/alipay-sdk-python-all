...
class AlipaySecurityProdAshieldHardeningtaskSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySecurityProdAshieldHardeningtaskSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySecurityProdAshieldHardeningtaskSubmitResponse, self).parse_response_content(response_content)

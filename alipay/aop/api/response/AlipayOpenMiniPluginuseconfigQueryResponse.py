...
class AlipayOpenMiniPluginuseconfigQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenMiniPluginuseconfigQueryResponse, self).__init__()
        self._page = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenMiniPluginuseconfigQueryResponse, self).parse_response_content(response_content)
        if 'page' in response:

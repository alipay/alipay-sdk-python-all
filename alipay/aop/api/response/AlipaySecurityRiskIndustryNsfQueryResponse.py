...
class AlipaySecurityRiskIndustryNsfQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipaySecurityRiskIndustryNsfQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipaySecurityRiskIndustryNsfQueryResponse, self).parse_response_content(response_content)

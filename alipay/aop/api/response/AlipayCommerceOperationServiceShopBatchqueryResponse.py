...
class AlipayCommerceOperationServiceShopBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceOperationServiceShopBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceOperationServiceShopBatchqueryResponse, self).parse_response_content(response_content)

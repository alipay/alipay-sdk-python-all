...
class AlipayBossBaseAnttaskTaskPauseResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossBaseAnttaskTaskPauseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossBaseAnttaskTaskPauseResponse, self).parse_response_content(response_content)

...
from alipay.aop.api.domain.DtCallRecord import DtCallRecord


class DatadigitalAicsDevinCallrecordQueryResponse(AlipayResponse):

    def __init__(self):
        super(DatadigitalAicsDevinCallrecordQueryResponse, self).__init__()
    ...
    def call_record_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, DtCallRecord):
                    self._call_record_list.append(i)
                else:
                    self._call_record_list.append(DtCallRecord.from_alipay_dict(i))
    @property
    ...
    def parse_response_content(self, response_content):
        response = super(DatadigitalAicsDevinCallrecordQueryResponse, self).parse_response_content(response_content)

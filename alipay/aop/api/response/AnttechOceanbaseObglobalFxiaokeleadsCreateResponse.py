...
class AnttechOceanbaseObglobalFxiaokeleadsCreateResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalFxiaokeleadsCreateResponse, self).__init__()
    ...
    def result(self, value):
        if isinstance(value, FxiaokeCreateLeadsParams):
            ...
            self._result = FxiaokeCreateLeadsParams.from_alipay_dict(value)

    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalFxiaokeleadsCreateResponse, self).parse_response_content(response_content)

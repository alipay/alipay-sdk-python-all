...
class AnttechOceanbaseObglobalContactModifyResponse(AlipayResponse):

    def __init__(self):
        super(AnttechOceanbaseObglobalContactModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechOceanbaseObglobalContactModifyResponse, self).parse_response_content(response_content)

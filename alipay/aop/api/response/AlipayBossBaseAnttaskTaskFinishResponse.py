...
class AlipayBossBaseAnttaskTaskFinishResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossBaseAnttaskTaskFinishResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossBaseAnttaskTaskFinishResponse, self).parse_response_content(response_content)

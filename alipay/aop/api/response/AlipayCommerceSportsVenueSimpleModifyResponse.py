...
class AlipayCommerceSportsVenueSimpleModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceSportsVenueSimpleModifyResponse, self).__init__()
        self._address = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceSportsVenueSimpleModifyResponse, self).parse_response_content(response_content)

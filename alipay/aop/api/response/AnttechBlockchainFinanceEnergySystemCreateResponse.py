...
class AnttechBlockchainFinanceEnergySystemCreateResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainFinanceEnergySystemCreateResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainFinanceEnergySystemCreateResponse, self).parse_response_content(response_content)

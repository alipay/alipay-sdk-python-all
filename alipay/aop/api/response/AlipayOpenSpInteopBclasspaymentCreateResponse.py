...
class AlipayOpenSpInteopBclasspaymentCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpInteopBclasspaymentCreateResponse, self).__init__()
        self._memos = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpInteopBclasspaymentCreateResponse, self).parse_response_content(response_content)

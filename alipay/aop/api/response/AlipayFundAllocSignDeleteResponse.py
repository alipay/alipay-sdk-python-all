...
class AlipayFundAllocSignDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AlipayFundAllocSignDeleteResponse, self).__init__()
        self._flow_id = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayFundAllocSignDeleteResponse, self).parse_response_content(response_content)

...
class AlipayCloudCloudpromoMallRenfundorderCancelResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCloudCloudpromoMallRenfundorderCancelResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCloudCloudpromoMallRenfundorderCancelResponse, self).parse_response_content(response_content)

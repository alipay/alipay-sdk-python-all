...
class AlipayInsSceneEmploymentGroupendorseAppendResponse(AlipayResponse):

    def __init__(self):
        super(AlipayInsSceneEmploymentGroupendorseAppendResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayInsSceneEmploymentGroupendorseAppendResponse, self).parse_response_content(response_content)

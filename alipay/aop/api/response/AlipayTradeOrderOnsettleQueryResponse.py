...
class AlipayTradeOrderOnsettleQueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayTradeOrderOnsettleQueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayTradeOrderOnsettleQueryResponse, self).parse_response_content(response_content)

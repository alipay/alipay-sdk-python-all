...
class AlipayCommerceTransportWorldVirtualcardBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceTransportWorldVirtualcardBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceTransportWorldVirtualcardBatchqueryResponse, self).parse_response_content(response_content)

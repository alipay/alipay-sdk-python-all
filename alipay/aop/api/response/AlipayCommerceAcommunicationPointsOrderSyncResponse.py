...
class AlipayCommerceAcommunicationPointsOrderSyncResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationPointsOrderSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationPointsOrderSyncResponse, self).parse_response_content(response_content)

...
class AlipayOverseasTaxTaxdataConfirmResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOverseasTaxTaxdataConfirmResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOverseasTaxTaxdataConfirmResponse, self).parse_response_content(response_content)

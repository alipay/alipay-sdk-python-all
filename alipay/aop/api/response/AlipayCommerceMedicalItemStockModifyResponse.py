...
class AlipayCommerceMedicalItemStockModifyResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMedicalItemStockModifyResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMedicalItemStockModifyResponse, self).parse_response_content(response_content)

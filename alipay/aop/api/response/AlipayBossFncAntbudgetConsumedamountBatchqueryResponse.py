...
class AlipayBossFncAntbudgetConsumedamountBatchqueryResponse(AlipayResponse):

    def __init__(self):
        super(AlipayBossFncAntbudgetConsumedamountBatchqueryResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayBossFncAntbudgetConsumedamountBatchqueryResponse, self).parse_response_content(response_content)

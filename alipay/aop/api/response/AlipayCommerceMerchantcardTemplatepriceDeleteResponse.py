...
class AlipayCommerceMerchantcardTemplatepriceDeleteResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceMerchantcardTemplatepriceDeleteResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceMerchantcardTemplatepriceDeleteResponse, self).parse_response_content(response_content)

...
class AnttechBlockchainDefinFinanceInterbankSubmitResponse(AlipayResponse):

    def __init__(self):
        super(AnttechBlockchainDefinFinanceInterbankSubmitResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AnttechBlockchainDefinFinanceInterbankSubmitResponse, self).parse_response_content(response_content)

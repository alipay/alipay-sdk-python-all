...
class AlipayCommerceAcommunicationCreditphoneOrderCloseResponse(AlipayResponse):

    def __init__(self):
        super(AlipayCommerceAcommunicationCreditphoneOrderCloseResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayCommerceAcommunicationCreditphoneOrderCloseResponse, self).parse_response_content(response_content)

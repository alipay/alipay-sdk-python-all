...
class AntMerchantExpandProductionOrderSyncResponse(AlipayResponse):

    def __init__(self):
        super(AntMerchantExpandProductionOrderSyncResponse, self).__init__()
    ...
    def parse_response_content(self, response_content):
        response = super(AntMerchantExpandProductionOrderSyncResponse, self).parse_response_content(response_content)

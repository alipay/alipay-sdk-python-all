...
class AlipayOpenSpInteopBrandchainCreateResponse(AlipayResponse):

    def __init__(self):
        super(AlipayOpenSpInteopBrandchainCreateResponse, self).__init__()
        self._memos = None
    ...
    def parse_response_content(self, response_content):
        response = super(AlipayOpenSpInteopBrandchainCreateResponse, self).parse_response_content(response_content)

...
from alipay.aop.api.domain.AcquirePayFlowShopInfo import AcquirePayFlowShopInfo


class AcquirePayFlow(object):
    ...
    def shop_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, AcquirePayFlowShopInfo):
                    self._shop_list.append(i)
                else:
                    self._shop_list.append(AcquirePayFlowShopInfo.from_alipay_dict(i))
    @property
    def shop_num(self):

...
from alipay.aop.api.domain.CeItemSkuAttrVO import CeItemSkuAttrVO


class CeItemSkuCreateVO(object):
    ...
    def sku_attrs(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, CeItemSkuAttrVO):
                    self._sku_attrs.append(i)
                else:
                    self._sku_attrs.append(CeItemSkuAttrVO.from_alipay_dict(i))
    @property
    def sku_type(self):

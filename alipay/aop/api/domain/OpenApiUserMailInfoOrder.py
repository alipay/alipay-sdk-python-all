...
class OpenApiUserMailInfoOrder(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.default_flag:
            if hasattr(self.default_flag, 'to_alipay_dict'):
                params['default_flag'] = self.default_flag.to_alipay_dict()
            else:
                params['default_flag'] = self.default_flag
    ...
    def from_alipay_dict(d):
        ...
        if 'default_flag' in d:
            o.default_flag = d['default_flag']

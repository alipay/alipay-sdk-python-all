...
class AlipayCommerceLifeserviceShopcopyBatchqueryModel(object):

    def __init__(self):
        self._city_codes = None
        self._copy_id_list = None
    ...
    @property
    def copy_id_list(self):
        return self._copy_id_list

    @copy_id_list.setter
    def copy_id_list(self, value):
        if isinstance(value, list):
            self._copy_id_list = list()
            for i in value:
                self._copy_id_list.append(i)
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.copy_id_list:
            if isinstance(self.copy_id_list, list):
                for i in range(0, len(self.copy_id_list)):
                    element = self.copy_id_list[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.copy_id_list[i] = element.to_alipay_dict()
            if hasattr(self.copy_id_list, 'to_alipay_dict'):
                params['copy_id_list'] = self.copy_id_list.to_alipay_dict()
            else:
                params['copy_id_list'] = self.copy_id_list
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceLifeserviceShopcopyBatchqueryModel()
        if 'city_codes' in d:
            o.city_codes = d['city_codes']
        if 'copy_id_list' in d:
            o.copy_id_list = d['copy_id_list']

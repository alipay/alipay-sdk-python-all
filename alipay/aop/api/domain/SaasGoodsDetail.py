...
class SaasGoodsDetail(object):
    ...
    def __init__(self):
        ...
        self._goods_specifications = None
    ...
    @property
    def goods_specifications(self):
        return self._goods_specifications

    @goods_specifications.setter
    def goods_specifications(self, value):
        self._goods_specifications = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.goods_specifications:
            if hasattr(self.goods_specifications, 'to_alipay_dict'):
                params['goods_specifications'] = self.goods_specifications.to_alipay_dict()
            else:
                params['goods_specifications'] = self.goods_specifications
        if self.out_item_id:
    ...
    def from_alipay_dict(d):
        ...
        if 'goods_specifications' in d:
            o.goods_specifications = d['goods_specifications']
        if 'out_item_id' in d:

...
class AlipayCloudCloudbaseCouponsAlterQueryModel(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.alter_type:
            if hasattr(self.alter_type, 'to_alipay_dict'):
                params['alter_type'] = self.alter_type.to_alipay_dict()
            else:
                params['alter_type'] = self.alter_type
        if self.biz_app_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCloudCloudbaseCouponsAlterQueryModel()
        if 'alter_spec_code' in d:
            o.alter_spec_code = d['alter_spec_code']
        if 'alter_type' in d:
            o.alter_type = d['alter_type']
        if 'biz_app_id' in d:

...
class ShopScoreResultInfoDTO(object):
    ...
    @property
    def cat_trd_amt_per_trd_score(self):
        return self._cat_trd_amt_per_trd_score

    @cat_trd_amt_per_trd_score.setter
    def cat_trd_amt_per_trd_score(self, value):
        self._cat_trd_amt_per_trd_score = value
    @property
    ...
    @property
    def trd_amt_per_trd_score(self):
        return self._trd_amt_per_trd_score

    @trd_amt_per_trd_score.setter
    def trd_amt_per_trd_score(self, value):
        self._trd_amt_per_trd_score = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.cat_trd_amt_per_trd_score:
            if hasattr(self.cat_trd_amt_per_trd_score, 'to_alipay_dict'):
                params['cat_trd_amt_per_trd_score'] = self.cat_trd_amt_per_trd_score.to_alipay_dict()
            else:
                params['cat_trd_amt_per_trd_score'] = self.cat_trd_amt_per_trd_score
        ...
        if self.trd_amt_per_trd_score:
            if hasattr(self.trd_amt_per_trd_score, 'to_alipay_dict'):
                params['trd_amt_per_trd_score'] = self.trd_amt_per_trd_score.to_alipay_dict()
            else:
                params['trd_amt_per_trd_score'] = self.trd_amt_per_trd_score
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = ShopScoreResultInfoDTO()
        if 'cat_sale_score' in d:
            o.cat_sale_score = d['cat_sale_score']
        if 'cat_trd_amt_per_trd_score' in d:
            o.cat_trd_amt_per_trd_score = d['cat_trd_amt_per_trd_score']
        ...
        if 'trd_amt_per_trd_score' in d:
            o.trd_amt_per_trd_score = d['trd_amt_per_trd_score']

...
from alipay.aop.api.domain.EpSpuSpecificInfo import EpSpuSpecificInfo


class EpSpuSpecificInfoResult(object):
    ...
    def spu_list(self, value):
        if isinstance(value, list):
            self._spu_list = list()
            for i in value:
                if isinstance(i, EpSpuSpecificInfo):
                    self._spu_list.append(i)
                else:
                    self._spu_list.append(EpSpuSpecificInfo.from_alipay_dict(i))

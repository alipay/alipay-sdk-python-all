...
class AlipayCommerceMedicalCommercialUnitModifyModel(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.unit_status:
            if hasattr(self.unit_status, 'to_alipay_dict'):
                params['unit_status'] = self.unit_status.to_alipay_dict()
            else:
                params['unit_status'] = self.unit_status
        return params
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceMedicalCommercialUnitModifyModel()
        if 'action' in d:
            o.action = d['action']

...
class AlipayOpenAgentIsvCreateModel(object):

    def __init__(self):
        self._agent_id = None
        self._agent_platform = None
    ...
    @property
    def agent_platform(self):
        return self._agent_platform

    @agent_platform.setter
    def agent_platform(self, value):
        self._agent_platform = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.agent_platform:
            if hasattr(self.agent_platform, 'to_alipay_dict'):
                params['agent_platform'] = self.agent_platform.to_alipay_dict()
            else:
                params['agent_platform'] = self.agent_platform
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayOpenAgentIsvCreateModel()
        if 'agent_id' in d:
            o.agent_id = d['agent_id']
        if 'agent_platform' in d:
            o.agent_platform = d['agent_platform']

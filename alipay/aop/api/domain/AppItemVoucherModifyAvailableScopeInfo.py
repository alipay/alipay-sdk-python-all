...
from alipay.aop.api.domain.VoucherAvailableModifyAppItemInfo import VoucherAvailableModifyAppItemInfo


class AppItemVoucherModifyAvailableScopeInfo(object):
    ...
    def app_item_voucher_available_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, VoucherAvailableModifyAppItemInfo):
                    self._app_item_voucher_available_info_list.append(i)
                else:
                    self._app_item_voucher_available_info_list.append(VoucherAvailableModifyAppItemInfo.from_alipay_dict(i))
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AppItemVoucherModifyAvailableScopeInfo()

...
from alipay.aop.api.domain.SubOrderDetailInfo import SubOrderDetailInfo


class AlipayCloudCloudpromoTicketOrdersUploadModel(object):
    ...
    @property
    def contacter_uid(self):
        return self._contacter_uid

    @contacter_uid.setter
    def contacter_uid(self, value):
        self._contacter_uid = value
    @property
    ...
    def order_details(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, SubOrderDetailInfo):
                    self._order_details.append(i)
                else:
                    self._order_details.append(SubOrderDetailInfo.from_alipay_dict(i))
    @property
    def order_id(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.contacter_uid:
            if hasattr(self.contacter_uid, 'to_alipay_dict'):
                params['contacter_uid'] = self.contacter_uid.to_alipay_dict()
            else:
                params['contacter_uid'] = self.contacter_uid
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCloudCloudpromoTicketOrdersUploadModel()
        ...
        if 'contacter_uid' in d:
            o.contacter_uid = d['contacter_uid']

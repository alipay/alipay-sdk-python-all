...
from alipay.aop.api.domain.RentInstallmentPlanPromoDetailInfoVO import RentInstallmentPlanPromoDetailInfoVO


class RentStagePromoDetailInfoVO(object):
    ...
    def installment_plan_promo_detail_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, RentInstallmentPlanPromoDetailInfoVO):
                    self._installment_plan_promo_detail_info_list.append(i)
                else:
                    self._installment_plan_promo_detail_info_list.append(RentInstallmentPlanPromoDetailInfoVO.from_alipay_dict(i))
    @property
    def stage_no(self):

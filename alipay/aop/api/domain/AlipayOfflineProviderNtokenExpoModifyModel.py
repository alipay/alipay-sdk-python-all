...
class AlipayOfflineProviderNtokenExpoModifyModel(object):
    ...
    def origin_token(self):
        return self._origin_token

    @origin_token.setter
    def origin_token(self, value):
        self._origin_token = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.origin_token:
            if hasattr(self.origin_token, 'to_alipay_dict'):
                params['origin_token'] = self.origin_token.to_alipay_dict()
            else:
                params['origin_token'] = self.origin_token
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayOfflineProviderNtokenExpoModifyModel()
        if 'head_img' in d:
        ...
        if 'origin_token' in d:
            o.origin_token = d['origin_token']

...
class OutBusinessItems(object):
    ...
    def __init__(self):
        ...
        self._out_writeoff_no = None
        self._to_subject_id = None
        self._to_subject_type = None
        self._writeoff_price = None
        self._writeoff_time = None
    ...
    @property
    def out_writeoff_no(self):
        return self._out_writeoff_no

    @out_writeoff_no.setter
    def out_writeoff_no(self, value):
        self._out_writeoff_no = value
    @property
    ...
    @property
    def writeoff_price(self):
        return self._writeoff_price

    @writeoff_price.setter
    def writeoff_price(self, value):
        self._writeoff_price = value
    @property
    def writeoff_time(self):
        return self._writeoff_time

    @writeoff_time.setter
    def writeoff_time(self, value):
        self._writeoff_time = value
    ...
    def to_alipay_dict(self):
        ...
        if self.out_writeoff_no:
            if hasattr(self.out_writeoff_no, 'to_alipay_dict'):
                params['out_writeoff_no'] = self.out_writeoff_no.to_alipay_dict()
            else:
                params['out_writeoff_no'] = self.out_writeoff_no
        ...
        if self.writeoff_price:
            if hasattr(self.writeoff_price, 'to_alipay_dict'):
                params['writeoff_price'] = self.writeoff_price.to_alipay_dict()
            else:
                params['writeoff_price'] = self.writeoff_price
        if self.writeoff_time:
            if hasattr(self.writeoff_time, 'to_alipay_dict'):
                params['writeoff_time'] = self.writeoff_time.to_alipay_dict()
            else:
                params['writeoff_time'] = self.writeoff_time
        return params
    ...
    def from_alipay_dict(d):
        ...
        if 'out_writeoff_no' in d:
            o.out_writeoff_no = d['out_writeoff_no']
        if 'to_subject_id' in d:
            o.to_subject_id = d['to_subject_id']
        if 'to_subject_type' in d:
            o.to_subject_type = d['to_subject_type']
        if 'writeoff_price' in d:
            o.writeoff_price = d['writeoff_price']
        if 'writeoff_time' in d:
            o.writeoff_time = d['writeoff_time']
        return o

...
from alipay.aop.api.domain.RentInstallmentInfoVO import RentInstallmentInfoVO


class RentPlanInfoVO(object):
    ...
    def installments(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, RentInstallmentInfoVO):
                    self._installments.append(i)
                else:
                    self._installments.append(RentInstallmentInfoVO.from_alipay_dict(i))
    @property

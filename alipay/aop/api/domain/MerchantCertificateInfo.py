...
class MerchantCertificateInfo(object):

    def __init__(self):
        self._back_cert_url = None
    ...
    @property
    def back_cert_url(self):
        return self._back_cert_url

    @back_cert_url.setter
    def back_cert_url(self, value):
        self._back_cert_url = value
    @property
    def cert_name(self):
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.back_cert_url:
            if hasattr(self.back_cert_url, 'to_alipay_dict'):
                params['back_cert_url'] = self.back_cert_url.to_alipay_dict()
            else:
                params['back_cert_url'] = self.back_cert_url
        if self.cert_name:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = MerchantCertificateInfo()
        if 'back_cert_url' in d:
            o.back_cert_url = d['back_cert_url']
        if 'cert_name' in d:

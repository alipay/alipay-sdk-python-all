...
class AlipayCommerceRetailBenefitmaterialCreateModel(object):
    ...
    def __init__(self):
        ...
        self._advertised_activity_id = None
    ...
    @property
    def advertised_activity_id(self):
        return self._advertised_activity_id

    @advertised_activity_id.setter
    def advertised_activity_id(self, value):
        self._advertised_activity_id = value
    @property
    def brand_name(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.advertised_activity_id:
            if hasattr(self.advertised_activity_id, 'to_alipay_dict'):
                params['advertised_activity_id'] = self.advertised_activity_id.to_alipay_dict()
            else:
                params['advertised_activity_id'] = self.advertised_activity_id
        if self.brand_name:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceRetailBenefitmaterialCreateModel()
        ...
        if 'advertised_activity_id' in d:
            o.advertised_activity_id = d['advertised_activity_id']
        if 'brand_name' in d:

...
class TaskDetailsInfo(object):

    def __init__(self):
        self._access_limit_count = None
        self._access_limit_dimension = None
    ...
    @property
    def access_limit_dimension(self):
        return self._access_limit_dimension

    @access_limit_dimension.setter
    def access_limit_dimension(self, value):
        self._access_limit_dimension = value
    @property
    ...
    @property
    def prize_detail_dto_list(self):
        return self._prize_detail_dto_list

    @prize_detail_dto_list.setter
    def prize_detail_dto_list(self, value):
        if isinstance(value, list):
            self._prize_detail_dto_list = list()
            for i in value:
                if isinstance(i, PrizeBaseInfo):
                    self._prize_detail_dto_list.append(i)
                else:
                    self._prize_detail_dto_list.append(PrizeBaseInfo.from_alipay_dict(i))
    @property
    ...
    @property
    def valid_prize_detail_dto(self):
        return self._valid_prize_detail_dto

    @valid_prize_detail_dto.setter
    def valid_prize_detail_dto(self, value):
        if isinstance(value, PrizeBaseInfo):
            self._valid_prize_detail_dto = value
        else:
            self._valid_prize_detail_dto = PrizeBaseInfo.from_alipay_dict(value)
    ...
    def to_alipay_dict(self):
        ...
        if self.access_limit_dimension:
            if hasattr(self.access_limit_dimension, 'to_alipay_dict'):
                params['access_limit_dimension'] = self.access_limit_dimension.to_alipay_dict()
            else:
                params['access_limit_dimension'] = self.access_limit_dimension
        ...
        if self.prize_detail_dto_list:
            if isinstance(self.prize_detail_dto_list, list):
                for i in range(0, len(self.prize_detail_dto_list)):
                    element = self.prize_detail_dto_list[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.prize_detail_dto_list[i] = element.to_alipay_dict()
            if hasattr(self.prize_detail_dto_list, 'to_alipay_dict'):
                params['prize_detail_dto_list'] = self.prize_detail_dto_list.to_alipay_dict()
            else:
                params['prize_detail_dto_list'] = self.prize_detail_dto_list
        ...
        if self.valid_prize_detail_dto:
            if hasattr(self.valid_prize_detail_dto, 'to_alipay_dict'):
                params['valid_prize_detail_dto'] = self.valid_prize_detail_dto.to_alipay_dict()
            else:
                params['valid_prize_detail_dto'] = self.valid_prize_detail_dto
        return params
    ...
    def from_alipay_dict(d):
        ...
        if 'access_limit_dimension' in d:
            o.access_limit_dimension = d['access_limit_dimension']
        ...
        if 'prize_detail_dto_list' in d:
            o.prize_detail_dto_list = d['prize_detail_dto_list']
        ...
        if 'valid_prize_detail_dto' in d:
            o.valid_prize_detail_dto = d['valid_prize_detail_dto']
        return o

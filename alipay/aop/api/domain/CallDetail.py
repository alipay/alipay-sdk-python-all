...
class CallDetail(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.release_reason:
            if hasattr(self.release_reason, 'to_alipay_dict'):
                params['release_reason'] = self.release_reason.to_alipay_dict()
            else:
                params['release_reason'] = self.release_reason
    ...
    def from_alipay_dict(d):
        ...
        if 'release_reason' in d:
            o.release_reason = d['release_reason']

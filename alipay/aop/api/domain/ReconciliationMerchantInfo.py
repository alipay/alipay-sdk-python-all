...
class ReconciliationMerchantInfo(object):
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.merchant_credit_no:
            if hasattr(self.merchant_credit_no, 'to_alipay_dict'):
                params['merchant_credit_no'] = self.merchant_credit_no.to_alipay_dict()
            else:
                params['merchant_credit_no'] = self.merchant_credit_no
        if self.merchant_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = ReconciliationMerchantInfo()
        if 'merchant_credit_no' in d:
            o.merchant_credit_no = d['merchant_credit_no']
        if 'merchant_id' in d:

...
class TransferUserName(object):
    ...
    @native_name.setter
    def native_name(self, value):
        self._native_name = value
    ...
    def to_alipay_dict(self):
        ...
        if self.native_name:
            if hasattr(self.native_name, 'to_alipay_dict'):
                params['native_name'] = self.native_name.to_alipay_dict()
            else:
                params['native_name'] = self.native_name
        return params

...
class DoctorServiceInfo(object):

    def __init__(self):
        self._service_icon = None
    ...
    def service_icon(self):
        return self._service_icon

    @service_icon.setter
    def service_icon(self, value):
        self._service_icon = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.service_icon:
            if hasattr(self.service_icon, 'to_alipay_dict'):
                params['service_icon'] = self.service_icon.to_alipay_dict()
            else:
                params['service_icon'] = self.service_icon
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = DoctorServiceInfo()
        if 'service_icon' in d:
            o.service_icon = d['service_icon']

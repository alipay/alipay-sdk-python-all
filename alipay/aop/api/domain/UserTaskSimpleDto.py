...
from alipay.aop.api.domain.UserTaskCountingDto import UserTaskCountingDto
from alipay.aop.api.domain.UserNodeTaskSimpleDto import UserNodeTaskSimpleDto
from alipay.aop.api.domain.TaskRightsRuleDto import TaskRightsRuleDto
from alipay.aop.api.domain.UserTaskRightsSimpleDto import UserTaskRightsSimpleDto


class UserTaskSimpleDto(object):

    def __init__(self):
        self._biz_info = None
        self._completed_time = None
        self._counting_info = None
        self._node_task_list = None
        self._out_user_task_id = None
        self._rights_rule_list = None
        self._sort = None
    ...
    def counting_info(self):
        return self._counting_info

    @counting_info.setter
    def counting_info(self, value):
        if isinstance(value, UserTaskCountingDto):
            self._counting_info = value
        else:
            self._counting_info = UserTaskCountingDto.from_alipay_dict(value)
    @property
    def node_task_list(self):
        return self._node_task_list

    @node_task_list.setter
    def node_task_list(self, value):
        if isinstance(value, list):
            self._node_task_list = list()
            for i in value:
                if isinstance(i, UserNodeTaskSimpleDto):
                    self._node_task_list.append(i)
                else:
                    self._node_task_list.append(UserNodeTaskSimpleDto.from_alipay_dict(i))
    @property
    ...
    @property
    def rights_rule_list(self):
        return self._rights_rule_list

    @rights_rule_list.setter
    def rights_rule_list(self, value):
        if isinstance(value, list):
            self._rights_rule_list = list()
            for i in value:
                if isinstance(i, TaskRightsRuleDto):
                    self._rights_rule_list.append(i)
                else:
                    self._rights_rule_list.append(TaskRightsRuleDto.from_alipay_dict(i))
    @property
    def sort(self):
        return self._sort
    ...
    def to_alipay_dict(self):
        ...
        if self.counting_info:
            if hasattr(self.counting_info, 'to_alipay_dict'):
                params['counting_info'] = self.counting_info.to_alipay_dict()
            else:
                params['counting_info'] = self.counting_info
        if self.node_task_list:
            if isinstance(self.node_task_list, list):
                for i in range(0, len(self.node_task_list)):
                    element = self.node_task_list[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.node_task_list[i] = element.to_alipay_dict()
            if hasattr(self.node_task_list, 'to_alipay_dict'):
                params['node_task_list'] = self.node_task_list.to_alipay_dict()
            else:
                params['node_task_list'] = self.node_task_list
        ...
        if self.rights_rule_list:
            if isinstance(self.rights_rule_list, list):
                for i in range(0, len(self.rights_rule_list)):
                    element = self.rights_rule_list[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.rights_rule_list[i] = element.to_alipay_dict()
            if hasattr(self.rights_rule_list, 'to_alipay_dict'):
                params['rights_rule_list'] = self.rights_rule_list.to_alipay_dict()
            else:
                params['rights_rule_list'] = self.rights_rule_list
        if self.sort:
    ...
    def from_alipay_dict(d):
        ...
        if 'counting_info' in d:
            o.counting_info = d['counting_info']
        if 'node_task_list' in d:
            o.node_task_list = d['node_task_list']
        if 'out_user_task_id' in d:
            o.out_user_task_id = d['out_user_task_id']
        if 'rights_rule_list' in d:
            o.rights_rule_list = d['rights_rule_list']
        if 'sort' in d:
            o.sort = d['sort']
        if 'task_cycle' in d:

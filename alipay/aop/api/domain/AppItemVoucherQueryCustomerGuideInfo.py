...
from alipay.aop.api.domain.AppItemVoucherQueryUseGuideInfo import AppItemVoucherQueryUseGuideInfo


class AppItemVoucherQueryCustomerGuideInfo(object):
    ...
    def app_item_voucher_use_guide_info(self, value):
        if isinstance(value, AppItemVoucherQueryUseGuideInfo):
            self._app_item_voucher_use_guide_info = value
        else:
            self._app_item_voucher_use_guide_info = AppItemVoucherQueryUseGuideInfo.from_alipay_dict(value)
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AppItemVoucherQueryCustomerGuideInfo()

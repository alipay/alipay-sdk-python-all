...
class AlipayDataDataexchangeSchemainputparamRainythetwiceQueryModel(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.complex_list_must:
            if isinstance(self.complex_list_must, list):
                for i in range(0, len(self.complex_list_must)):
                    element = self.complex_list_must[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.complex_list_must[i] = element.to_alipay_dict()
            if hasattr(self.complex_list_must, 'to_alipay_dict'):
                params['complex_list_must'] = self.complex_list_must.to_alipay_dict()
            else:
                params['complex_list_must'] = self.complex_list_must
        if self.complex_must:
            if hasattr(self.complex_must, 'to_alipay_dict'):
                params['complex_must'] = self.complex_must.to_alipay_dict()
            else:
                params['complex_must'] = self.complex_must
        ...
        if self.price_list_optional:
            if isinstance(self.price_list_optional, list):
                for i in range(0, len(self.price_list_optional)):
                    element = self.price_list_optional[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.price_list_optional[i] = element.to_alipay_dict()
            if hasattr(self.price_list_optional, 'to_alipay_dict'):
                params['price_list_optional'] = self.price_list_optional.to_alipay_dict()
            else:
                params['price_list_optional'] = self.price_list_optional
        if self.price_must:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayDataDataexchangeSchemainputparamRainythetwiceQueryModel()
        ...
        if 'complex_list_must' in d:
            o.complex_list_must = d['complex_list_must']
        if 'complex_must' in d:
            o.complex_must = d['complex_must']
        ...
        if 'price_list_optional' in d:
            o.price_list_optional = d['price_list_optional']
        if 'price_must' in d:

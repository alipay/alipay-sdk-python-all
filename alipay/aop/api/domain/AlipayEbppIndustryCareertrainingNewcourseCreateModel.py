...
from alipay.aop.api.domain.ClassInfoVO import ClassInfoVO
from alipay.aop.api.domain.SyllabusStructuredCreateVO import SyllabusStructuredCreateVO
from alipay.aop.api.domain.TeacherVO import TeacherVO


class AlipayEbppIndustryCareertrainingNewcourseCreateModel(object):
    ...
    def plan_rule_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ClassInfoVO):
                    self._plan_rule_list.append(i)
                else:
                    self._plan_rule_list.append(ClassInfoVO.from_alipay_dict(i))
    @property
    def pt_hours(self):
    ...
    def syllabus_structured(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, SyllabusStructuredCreateVO):
                    self._syllabus_structured.append(i)
                else:
                    self._syllabus_structured.append(SyllabusStructuredCreateVO.from_alipay_dict(i))
    @property
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayEbppIndustryCareertrainingNewcourseCreateModel()

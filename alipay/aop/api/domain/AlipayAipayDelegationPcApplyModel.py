...
from alipay.aop.api.domain.PcConversationHistory import PcConversationHistory
from alipay.aop.api.domain.PcDelegationParams import PcDelegationParams
from alipay.aop.api.domain.DelegationExtInfo import DelegationExtInfo


class AlipayAipayDelegationPcApplyModel(object):
    ...
    def conversation_history(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, PcConversationHistory):
                    self._conversation_history.append(i)
                else:
                    self._conversation_history.append(PcConversationHistory.from_alipay_dict(i))
    @property
    ...
    def delegation_params(self, value):
        if isinstance(value, PcDelegationParams):
            self._delegation_params = value
        else:
            self._delegation_params = PcDelegationParams.from_alipay_dict(value)
    @property
    def ext_info(self):
    ...
    def ext_info(self, value):
        if isinstance(value, DelegationExtInfo):
            self._ext_info = value
        else:
            self._ext_info = DelegationExtInfo.from_alipay_dict(value)
    @property
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayAipayDelegationPcApplyModel()

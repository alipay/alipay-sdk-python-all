...
from alipay.aop.api.domain.RentServiceProtocolVO import RentServiceProtocolVO


class RentPathInfoVO(object):
    ...
    def protocols(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, RentServiceProtocolVO):
                    self._protocols.append(i)
                else:
                    self._protocols.append(RentServiceProtocolVO.from_alipay_dict(i))
    @property
    def relet_path(self):

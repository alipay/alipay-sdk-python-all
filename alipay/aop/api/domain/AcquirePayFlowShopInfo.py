...
from alipay.aop.api.domain.AcquirePayFlowTransDetailInfo import AcquirePayFlowTransDetailInfo


class AcquirePayFlowShopInfo(object):
    ...
    def detail_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, AcquirePayFlowTransDetailInfo):
                    self._detail_list.append(i)
                else:
                    self._detail_list.append(AcquirePayFlowTransDetailInfo.from_alipay_dict(i))
    @property
    def district(self):
    ...
    @property
    def is_ent_shop(self):
        return self._is_ent_shop

    @is_ent_shop.setter
    def is_ent_shop(self, value):
        self._is_ent_shop = value
    @property
    def last_date(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.is_ent_shop:
            if hasattr(self.is_ent_shop, 'to_alipay_dict'):
                params['is_ent_shop'] = self.is_ent_shop.to_alipay_dict()
            else:
                params['is_ent_shop'] = self.is_ent_shop
        if self.last_date:

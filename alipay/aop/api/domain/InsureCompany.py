...
class InsureCompany(object):
    ...
    def __init__(self):
        ...
        self._channel_account_open_id = None
    ...
    @property
    def channel_account_open_id(self):
        return self._channel_account_open_id

    @channel_account_open_id.setter
    def channel_account_open_id(self, value):
        self._channel_account_open_id = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.channel_account_open_id:
            if hasattr(self.channel_account_open_id, 'to_alipay_dict'):
                params['channel_account_open_id'] = self.channel_account_open_id.to_alipay_dict()
            else:
                params['channel_account_open_id'] = self.channel_account_open_id
    ...
    def from_alipay_dict(d):
        ...
        if 'channel_account_open_id' in d:
            o.channel_account_open_id = d['channel_account_open_id']

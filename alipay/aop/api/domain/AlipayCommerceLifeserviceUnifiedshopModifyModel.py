...
from alipay.aop.api.domain.LumBusinessLicenseInfo import LumBusinessLicenseInfo
from alipay.aop.api.domain.LumContactWayInfo import LumContactWayInfo
from alipay.aop.api.domain.LumLegalPersonInfo import LumLegalPersonInfo
from alipay.aop.api.domain.LumStoreAddressInfo import LumStoreAddressInfo


class AlipayCommerceLifeserviceUnifiedshopModifyModel(object):
    ...
    def business_license_info(self, value):
        if isinstance(value, LumBusinessLicenseInfo):
            self._business_license_info = value
        else:
            self._business_license_info = LumBusinessLicenseInfo.from_alipay_dict(value)
    @property
    ...
    def contact_ways(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, LumContactWayInfo):
                    self._contact_ways.append(i)
                else:
                    self._contact_ways.append(LumContactWayInfo.from_alipay_dict(i))
    @property
    def copy_id(self):
    ...
    def legal_person_info(self, value):
        if isinstance(value, LumLegalPersonInfo):
            self._legal_person_info = value
        else:
            self._legal_person_info = LumLegalPersonInfo.from_alipay_dict(value)
    @property
    ...
    def store_address_info(self, value):
        if isinstance(value, LumStoreAddressInfo):
            self._store_address_info = value
        else:
            self._store_address_info = LumStoreAddressInfo.from_alipay_dict(value)
    @property
    def store_id(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.update_from:
            if hasattr(self.update_from, 'to_alipay_dict'):
                params['update_from'] = self.update_from.to_alipay_dict()
            else:
                params['update_from'] = self.update_from
        return params
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceLifeserviceUnifiedshopModifyModel()

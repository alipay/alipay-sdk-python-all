...
from alipay.aop.api.domain.LogisticsOrderModifyDTO import LogisticsOrderModifyDTO


class AlipayOpenMiniOrderLogisticsinfoModifyModel(object):
    ...
    def logistics_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, LogisticsOrderModifyDTO):
                    self._logistics_list.append(i)
                else:
                    self._logistics_list.append(LogisticsOrderModifyDTO.from_alipay_dict(i))
    @property
    def open_id(self):
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayOpenMiniOrderLogisticsinfoModifyModel()

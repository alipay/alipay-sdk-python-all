...
from alipay.aop.api.domain.BianqueConfigItem import BianqueConfigItem


class AlipayCommerceMedicalYpzConfigSyncModel(object):
    ...
    def data_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, BianqueConfigItem):
                    self._data_list.append(i)
                else:
                    self._data_list.append(BianqueConfigItem.from_alipay_dict(i))
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceMedicalYpzConfigSyncModel()
        if 'data_list' in d:

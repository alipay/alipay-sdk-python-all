...
class AlipayEcoMycarSubscriptionOrderSyncModel(object):
    ...
    def deduction_info(self, value):
        if isinstance(value, CarSubscriptionDeduction):
            ...
            self._deduction_info = CarSubscriptionDeduction.from_alipay_dict(value)
    @property
    def item_id(self):
    ...
    def order_info(self, value):
        if isinstance(value, CarSubscriptionOrder):
            ...
            self._order_info = CarSubscriptionOrder.from_alipay_dict(value)
    @property
    def out_biz_id(self):
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayEcoMycarSubscriptionOrderSyncModel()
        if 'biz_status' in d:

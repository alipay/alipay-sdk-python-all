...
class QueryInvoiceDetail(object):
    ...
    @property
    def walle_source_id(self):
        return self._walle_source_id

    @walle_source_id.setter
    def walle_source_id(self, value):
        self._walle_source_id = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.walle_source_id:
            if hasattr(self.walle_source_id, 'to_alipay_dict'):
                params['walle_source_id'] = self.walle_source_id.to_alipay_dict()
            else:
                params['walle_source_id'] = self.walle_source_id
    ...
    def from_alipay_dict(d):
        ...
        if 'walle_source_id' in d:
            o.walle_source_id = d['walle_source_id']

...
from alipay.aop.api.domain.ObfBillStandardAcceptanceRequest import ObfBillStandardAcceptanceRequest


class AnttechOceanbaseBillStandardacceptanceSyncModel(object):
    ...
    def obf_bill_acceptance_request(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ObfBillStandardAcceptanceRequest):
                    self._obf_bill_acceptance_request.append(i)
                else:
                    self._obf_bill_acceptance_request.append(ObfBillStandardAcceptanceRequest.from_alipay_dict(i))
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AnttechOceanbaseBillStandardacceptanceSyncModel()

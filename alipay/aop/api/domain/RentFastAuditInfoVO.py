...
from alipay.aop.api.domain.RentFastAuditTaskInfoVO import RentFastAuditTaskInfoVO


class RentFastAuditInfoVO(object):
    ...
    def fast_audit_task_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, RentFastAuditTaskInfoVO):
                    self._fast_audit_task_info_list.append(i)
                else:
                    self._fast_audit_task_info_list.append(RentFastAuditTaskInfoVO.from_alipay_dict(i))
    @property

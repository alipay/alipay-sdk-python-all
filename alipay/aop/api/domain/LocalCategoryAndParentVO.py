...
from alipay.aop.api.domain.LocalAppxCategoryVO import LocalAppxCategoryVO


class LocalCategoryAndParentVO(object):
    ...
    def cat_and_parent(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, LocalAppxCategoryVO):
                    self._cat_and_parent.append(i)
                else:
                    self._cat_and_parent.append(LocalAppxCategoryVO.from_alipay_dict(i))

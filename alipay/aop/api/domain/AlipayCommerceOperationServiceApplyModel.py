...
class AlipayCommerceOperationServiceApplyModel(object):
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.apply_data:
            if hasattr(self.apply_data, 'to_alipay_dict'):
                params['apply_data'] = self.apply_data.to_alipay_dict()
            else:
                params['apply_data'] = self.apply_data
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceOperationServiceApplyModel()
        if 'apply_data' in d:
            o.apply_data = d['apply_data']

...
class CarinfosQuery(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.insert_time:
            if hasattr(self.insert_time, 'to_alipay_dict'):
                params['insert_time'] = self.insert_time.to_alipay_dict()
            else:
                params['insert_time'] = self.insert_time
        if self.plate_color:

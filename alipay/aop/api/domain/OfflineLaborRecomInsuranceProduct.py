...
from alipay.aop.api.domain.OfflineLaborRecomInsuranceResource import OfflineLaborRecomInsuranceResource


class OfflineLaborRecomInsuranceProduct(object):
    ...
    def resource_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, OfflineLaborRecomInsuranceResource):
                    self._resource_list.append(i)
                else:
                    self._resource_list.append(OfflineLaborRecomInsuranceResource.from_alipay_dict(i))
    @property
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = OfflineLaborRecomInsuranceProduct()

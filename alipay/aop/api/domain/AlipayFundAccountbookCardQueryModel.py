...
class AlipayFundAccountbookCardQueryModel(object):
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.account_book_card_no:
            if hasattr(self.account_book_card_no, 'to_alipay_dict'):
                params['account_book_card_no'] = self.account_book_card_no.to_alipay_dict()
            else:
                params['account_book_card_no'] = self.account_book_card_no
        if self.ext_info:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayFundAccountbookCardQueryModel()
        if 'account_book_card_no' in d:
            o.account_book_card_no = d['account_book_card_no']
        if 'ext_info' in d:

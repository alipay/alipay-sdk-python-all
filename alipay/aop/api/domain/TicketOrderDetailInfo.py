...
from alipay.aop.api.domain.TicketPassager import TicketPassager


class TicketOrderDetailInfo(object):
    ...
    def passagers(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, TicketPassager):
                    self._passagers.append(i)
                else:
                    self._passagers.append(TicketPassager.from_alipay_dict(i))

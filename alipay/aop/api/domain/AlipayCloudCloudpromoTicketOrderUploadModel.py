...
from alipay.aop.api.domain.TicketUserInfo import TicketUserInfo
from alipay.aop.api.domain.TicketUserInfo import TicketUserInfo


class AlipayCloudCloudpromoTicketOrderUploadModel(object):

    def __init__(self):
        self._actual_amount = None
        self._contacter = None
    ...
    @property
    def contacter(self):
        return self._contacter

    @contacter.setter
    def contacter(self, value):
        if isinstance(value, TicketUserInfo):
            self._contacter = value
        else:
            self._contacter = TicketUserInfo.from_alipay_dict(value)
    @property
    ...
    def passagers(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, TicketUserInfo):
                    self._passagers.append(i)
                else:
                    self._passagers.append(TicketUserInfo.from_alipay_dict(i))
    @property
    def start_time(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.contacter:
            if hasattr(self.contacter, 'to_alipay_dict'):
                params['contacter'] = self.contacter.to_alipay_dict()
            else:
                params['contacter'] = self.contacter
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCloudCloudpromoTicketOrderUploadModel()
        if 'actual_amount' in d:
            o.actual_amount = d['actual_amount']
        if 'contacter' in d:
            o.contacter = d['contacter']

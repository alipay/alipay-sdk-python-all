...
from alipay.aop.api.domain.CommercializationCustomizeRuleReq import CommercializationCustomizeRuleReq


class AlipayFincoreComplianceRcservsmartCustomizerulePublishModel(object):
    ...
    def rcsmart_biz_request(self, value):
        if isinstance(value, CommercializationCustomizeRuleReq):
            self._rcsmart_biz_request = value
        else:
            self._rcsmart_biz_request = CommercializationCustomizeRuleReq.from_alipay_dict(value)
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayFincoreComplianceRcservsmartCustomizerulePublishModel()
        if 'app_info' in d:

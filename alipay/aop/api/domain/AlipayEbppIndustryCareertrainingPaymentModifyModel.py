...
class AlipayEbppIndustryCareertrainingPaymentModifyModel(object):
    ...
    def payment_way(self):
        return self._payment_way

    @payment_way.setter
    def payment_way(self, value):
        self._payment_way = value
    @property
    def user_id(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.payment_way:
            if hasattr(self.payment_way, 'to_alipay_dict'):
                params['payment_way'] = self.payment_way.to_alipay_dict()
            else:
                params['payment_way'] = self.payment_way
        if self.user_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayEbppIndustryCareertrainingPaymentModifyModel()
        if 'biz_code' in d:

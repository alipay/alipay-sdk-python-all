...
class ObfBillStandardAcceptanceRequest(object):
    ...
    def __init__(self):
        ...
        self._standard_event_type = None
        self._tax_rate = None
    ...
    @property
    def standard_event_type(self):
        return self._standard_event_type

    @standard_event_type.setter
    def standard_event_type(self, value):
        self._standard_event_type = value
    @property
    def tax_rate(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.standard_event_type:
            if hasattr(self.standard_event_type, 'to_alipay_dict'):
                params['standard_event_type'] = self.standard_event_type.to_alipay_dict()
            else:
                params['standard_event_type'] = self.standard_event_type
        if self.tax_rate:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = ObfBillStandardAcceptanceRequest()
        ...
        if 'standard_event_type' in d:
            o.standard_event_type = d['standard_event_type']
        if 'tax_rate' in d:

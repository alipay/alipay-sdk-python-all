...
class SportsToolRecord(object):
    ...
    def __init__(self):
        ...
        self._run_face_verify_pass = None
        self._speed = None
    ...
    @property
    def run_face_verify_pass(self):
        return self._run_face_verify_pass

    @run_face_verify_pass.setter
    def run_face_verify_pass(self, value):
        self._run_face_verify_pass = value
    @property
    def speed(self):
        return self._speed
    ...
    def to_alipay_dict(self):
        ...
        if self.run_face_verify_pass:
            if hasattr(self.run_face_verify_pass, 'to_alipay_dict'):
                params['run_face_verify_pass'] = self.run_face_verify_pass.to_alipay_dict()
            else:
                params['run_face_verify_pass'] = self.run_face_verify_pass
        if self.speed:
    ...
    def from_alipay_dict(d):
        ...
        if 'run_face_verify_pass' in d:
            o.run_face_verify_pass = d['run_face_verify_pass']
        if 'speed' in d:
            o.speed = d['speed']

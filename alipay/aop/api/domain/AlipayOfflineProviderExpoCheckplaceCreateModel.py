...
class AlipayOfflineProviderExpoCheckplaceCreateModel(object):
    ...
    @property
    def rel_biz_id(self):
        return self._rel_biz_id

    @rel_biz_id.setter
    def rel_biz_id(self, value):
        self._rel_biz_id = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.rel_biz_id:
            if hasattr(self.rel_biz_id, 'to_alipay_dict'):
                params['rel_biz_id'] = self.rel_biz_id.to_alipay_dict()
            else:
                params['rel_biz_id'] = self.rel_biz_id
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayOfflineProviderExpoCheckplaceCreateModel()

...
from alipay.aop.api.domain.ItemUpdateByIdParam import ItemUpdateByIdParam


class AlipayCommerceMedicalItemByidModifyModel(object):
    ...
    def item_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ItemUpdateByIdParam):
                    self._item_list.append(i)
                else:
                    self._item_list.append(ItemUpdateByIdParam.from_alipay_dict(i))
    @property
    def store_code(self):
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceMedicalItemByidModifyModel()
        if 'item_list' in d:

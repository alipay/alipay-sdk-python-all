...
from alipay.aop.api.domain.AgmTagDTO import AgmTagDTO


class TemplateInstacneDTO(object):
    ...
    def tags(self, value):
        if isinstance(value, list):
            self._tags = list()
            for i in value:
                if isinstance(i, AgmTagDTO):
                    self._tags.append(i)
                else:
                    self._tags.append(AgmTagDTO.from_alipay_dict(i))
    @property

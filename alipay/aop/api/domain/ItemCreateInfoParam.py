...
from alipay.aop.api.domain.SkuCreateInfoParam import SkuCreateInfoParam


class ItemCreateInfoParam(object):
    ...
    def sku_list(self, value):
        if isinstance(value, list):
            self._sku_list = list()
            for i in value:
                if isinstance(i, SkuCreateInfoParam):
                    self._sku_list.append(i)
                else:
                    self._sku_list.append(SkuCreateInfoParam.from_alipay_dict(i))
    @property
    def status(self):
        return self._status
    ...
    def status(self, value):
        self._status = value
    @property
    def supply_chain_type(self):
        return self._supply_chain_type

    @supply_chain_type.setter
    def supply_chain_type(self, value):
        self._supply_chain_type = value
    @property
    def tag_code(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.supply_chain_type:
            if hasattr(self.supply_chain_type, 'to_alipay_dict'):
                params['supply_chain_type'] = self.supply_chain_type.to_alipay_dict()
            else:
                params['supply_chain_type'] = self.supply_chain_type
        if self.tag_code:
    ...
    def from_alipay_dict(d):
        ...
        if 'status' in d:
            o.status = d['status']
        if 'supply_chain_type' in d:
            o.supply_chain_type = d['supply_chain_type']
        if 'tag_code' in d:

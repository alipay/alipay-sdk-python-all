...
class AlipayEcoMycarCommercializationCertificateVerifyModel(object):

    def __init__(self):
        self._ant_store_id = None
        self._certificate_use_info_list = None
        self._has_freeze = None
        self._open_id = None
    ...
    @has_freeze.setter
    def has_freeze(self, value):
        self._has_freeze = value
    @property
    def open_id(self):
    ...
    def to_alipay_dict(self):
        ...
        if self.has_freeze:
            if hasattr(self.has_freeze, 'to_alipay_dict'):
                params['has_freeze'] = self.has_freeze.to_alipay_dict()
            else:
                params['has_freeze'] = self.has_freeze
        if self.open_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayEcoMycarCommercializationCertificateVerifyModel()

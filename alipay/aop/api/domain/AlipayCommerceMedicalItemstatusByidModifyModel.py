...
from alipay.aop.api.domain.ItemIdStatusInfo import ItemIdStatusInfo


class AlipayCommerceMedicalItemstatusByidModifyModel(object):
    ...
    def item_info_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ItemIdStatusInfo):
                    self._item_info_list.append(i)
                else:
                    self._item_info_list.append(ItemIdStatusInfo.from_alipay_dict(i))
    @property
    def store_code(self):
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceMedicalItemstatusByidModifyModel()

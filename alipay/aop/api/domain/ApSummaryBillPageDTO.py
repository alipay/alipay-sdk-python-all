...
from alipay.aop.api.domain.ApSummaryBillResponseDTO import ApSummaryBillResponseDTO


class ApSummaryBillPageDTO(object):
    ...
    def datas(self, value):
        if isinstance(value, ApSummaryBillResponseDTO):
            self._datas = value
        else:
            self._datas = ApSummaryBillResponseDTO.from_alipay_dict(value)
    @property
    def page_size(self):

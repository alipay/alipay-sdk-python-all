...
class AnttechNftCtocRealtimeTransferModel(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.pre_check_id:
            if hasattr(self.pre_check_id, 'to_alipay_dict'):
                params['pre_check_id'] = self.pre_check_id.to_alipay_dict()
            else:
                params['pre_check_id'] = self.pre_check_id
        if self.to_id_no:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AnttechNftCtocRealtimeTransferModel()
        ...
        if 'pre_check_id' in d:
            o.pre_check_id = d['pre_check_id']
        if 'to_id_no' in d:

...
class AlipayContentLiveCommentSyncModel(object):
    ...
    @property
    def out_user_identity(self):
        return self._out_user_identity

    @out_user_identity.setter
    def out_user_identity(self, value):
        self._out_user_identity = value
    @property
    def scene(self):
        return self._scene
    ...
    def scene(self, value):
        self._scene = value
    @property
    def tail_link_url(self):
        return self._tail_link_url
    ...
    def to_alipay_dict(self):
        ...
        if self.out_user_identity:
            if hasattr(self.out_user_identity, 'to_alipay_dict'):
                params['out_user_identity'] = self.out_user_identity.to_alipay_dict()
            else:
                params['out_user_identity'] = self.out_user_identity
        if self.scene:
            if hasattr(self.scene, 'to_alipay_dict'):
                params['scene'] = self.scene.to_alipay_dict()
            else:
                params['scene'] = self.scene
        if self.tail_link_url:
            if hasattr(self.tail_link_url, 'to_alipay_dict'):
    ...
    def from_alipay_dict(d):
        ...
        if 'out_user_identity' in d:
            o.out_user_identity = d['out_user_identity']
        if 'scene' in d:
            o.scene = d['scene']

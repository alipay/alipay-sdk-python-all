...
class ShopPageQueryDetailVO(object):
    ...
    def new_business_time(self, value):
        if isinstance(value, ComplexBusinessTime):
            self._new_business_time = value
        else:
            self._new_business_time = ComplexBusinessTime.from_alipay_dict(value)
    @property
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.alipay_poiid:
            if hasattr(self.alipay_poiid, 'to_alipay_dict'):
                params['alipay_poiid'] = self.alipay_poiid.to_alipay_dict()
            else:
                params['alipay_poiid'] = self.alipay_poiid
        if self.brand_id:
        ...
        if self.card_account_no:
            if hasattr(self.card_account_no, 'to_alipay_dict'):
                params['card_account_no'] = self.card_account_no.to_alipay_dict()
            else:
                params['card_account_no'] = self.card_account_no
        if self.cert_image:
        ...
        if self.shop_recommend_info:
            if hasattr(self.shop_recommend_info, 'to_alipay_dict'):
                params['shop_recommend_info'] = self.shop_recommend_info.to_alipay_dict()
            else:
                params['shop_recommend_info'] = self.shop_recommend_info
        if self.shop_type:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = ShopPageQueryDetailVO()
        if 'alipay_poiid' in d:
            o.alipay_poiid = d['alipay_poiid']
        if 'brand_id' in d:
        ...
        if 'card_account_no' in d:
            o.card_account_no = d['card_account_no']
        if 'cert_image' in d:
        ...
        if 'shop_recommend_info' in d:
            o.shop_recommend_info = d['shop_recommend_info']
        if 'shop_type' in d:

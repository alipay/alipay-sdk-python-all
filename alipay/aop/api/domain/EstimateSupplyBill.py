...
from alipay.aop.api.domain.BillFeeItem import BillFeeItem


class EstimateSupplyBill(object):
    ...
    def fee_item_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, BillFeeItem):
                    self._fee_item_list.append(i)
                else:
                    self._fee_item_list.append(BillFeeItem.from_alipay_dict(i))
    @property
    def pay_amount(self):

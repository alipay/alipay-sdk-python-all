...
class AlipaySecurityProdTemplateVersionQueryModel(object):
    ...
    @property
    def need_pdf(self):
        return self._need_pdf

    @need_pdf.setter
    def need_pdf(self, value):
        self._need_pdf = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.need_pdf:
            if hasattr(self.need_pdf, 'to_alipay_dict'):
                params['need_pdf'] = self.need_pdf.to_alipay_dict()
            else:
                params['need_pdf'] = self.need_pdf
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipaySecurityProdTemplateVersionQueryModel()
        if 'emp_id' in d:
            o.emp_id = d['emp_id']
        if 'need_pdf' in d:
            o.need_pdf = d['need_pdf']

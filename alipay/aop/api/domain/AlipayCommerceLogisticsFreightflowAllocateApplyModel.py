...
class AlipayCommerceLogisticsFreightflowAllocateApplyModel(object):

    def __init__(self):
        self._allocate_direction = None
        self._amount = None
        self._biz_no = None
        self._currency = None
    ...
    @property
    def allocate_direction(self):
        return self._allocate_direction

    @allocate_direction.setter
    def allocate_direction(self, value):
        self._allocate_direction = value
    @property
    def amount(self):
        return self._amount
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.allocate_direction:
            if hasattr(self.allocate_direction, 'to_alipay_dict'):
                params['allocate_direction'] = self.allocate_direction.to_alipay_dict()
            else:
                params['allocate_direction'] = self.allocate_direction
        if self.amount:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceLogisticsFreightflowAllocateApplyModel()
        if 'allocate_direction' in d:
            o.allocate_direction = d['allocate_direction']
        if 'amount' in d:
            o.amount = d['amount']
        if 'biz_no' in d:
            o.biz_no = d['biz_no']

...
from alipay.aop.api.domain.ExaminationSecondCategoryInfo import ExaminationSecondCategoryInfo


class ExaminationCategoryInfo(object):
    ...
    def children_list(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ExaminationSecondCategoryInfo):
                    self._children_list.append(i)
                else:
                    self._children_list.append(ExaminationSecondCategoryInfo.from_alipay_dict(i))
    @property
    def id(self):
        return self._id

...
class DesignatedDriverInfo(object):

    def __init__(self):
        self._concat_phone = None
        ...
        self._star_lever = None

    @property
    def concat_phone(self):
        return self._concat_phone

    @concat_phone.setter
    def concat_phone(self, value):
        self._concat_phone = value
    @property
    ...
    @property
    def star_lever(self):
        return self._star_lever

    @star_lever.setter
    def star_lever(self, value):
        self._star_lever = value


    def to_alipay_dict(self):
        params = dict()
        if self.concat_phone:
            if hasattr(self.concat_phone, 'to_alipay_dict'):
                params['concat_phone'] = self.concat_phone.to_alipay_dict()
            else:
                params['concat_phone'] = self.concat_phone
        ...
        if self.star_lever:
            if hasattr(self.star_lever, 'to_alipay_dict'):
                params['star_lever'] = self.star_lever.to_alipay_dict()
            else:
                params['star_lever'] = self.star_lever
        return params
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = DesignatedDriverInfo()
        if 'concat_phone' in d:
            o.concat_phone = d['concat_phone']

...
class AlipayDataDataserviceAdcampaignCreativeBatchqueryModel(object):
    ...
    @property
    def creative_status_list(self):
        return self._creative_status_list

    @creative_status_list.setter
    def creative_status_list(self, value):
        if isinstance(value, list):
            self._creative_status_list = list()
            for i in value:
                self._creative_status_list.append(i)
    @property
    def current(self):
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.creative_status_list:
            if isinstance(self.creative_status_list, list):
                for i in range(0, len(self.creative_status_list)):
                    element = self.creative_status_list[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.creative_status_list[i] = element.to_alipay_dict()
            if hasattr(self.creative_status_list, 'to_alipay_dict'):
                params['creative_status_list'] = self.creative_status_list.to_alipay_dict()
            else:
                params['creative_status_list'] = self.creative_status_list
        if self.current:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayDataDataserviceAdcampaignCreativeBatchqueryModel()
        if 'creative_status_list' in d:

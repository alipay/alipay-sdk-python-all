...
class AlipayPcreditLoanHonorContractlistQueryModel(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.bind_check_serial_no:
            if hasattr(self.bind_check_serial_no, 'to_alipay_dict'):
                params['bind_check_serial_no'] = self.bind_check_serial_no.to_alipay_dict()
            else:
                params['bind_check_serial_no'] = self.bind_check_serial_no
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayPcreditLoanHonorContractlistQueryModel()
        if 'alipay_user_id' in d:
            o.alipay_user_id = d['alipay_user_id']
        if 'bind_check_serial_no' in d:
            o.bind_check_serial_no = d['bind_check_serial_no']

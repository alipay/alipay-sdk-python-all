...
class ContractInformation(object):
    ...
    @property
    def sign_remark(self):
        return self._sign_remark

    @sign_remark.setter
    def sign_remark(self, value):
        self._sign_remark = value
    @property
    def tenant(self):
        return self._tenant
    ...
    def to_alipay_dict(self):
        ...
        if self.sign_remark:
            if hasattr(self.sign_remark, 'to_alipay_dict'):
                params['sign_remark'] = self.sign_remark.to_alipay_dict()
            else:
                params['sign_remark'] = self.sign_remark
        if self.tenant:

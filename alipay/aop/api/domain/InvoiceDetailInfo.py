...
class InvoiceDetailInfo(object):

    def __init__(self):
        self._invoice_buyer_info = None
        self._invoice_create_time = None
        ...
        self._invoice_modified_time = None
    ...
    @property
    def invoice_create_time(self):
        return self._invoice_create_time

    @invoice_create_time.setter
    def invoice_create_time(self, value):
        self._invoice_create_time = value
    @property
    ...
    @property
    def invoice_modified_time(self):
        return self._invoice_modified_time

    @invoice_modified_time.setter
    def invoice_modified_time(self, value):
        self._invoice_modified_time = value
    @property
    ...
    def to_alipay_dict(self):
        ...
        if self.invoice_create_time:
            if hasattr(self.invoice_create_time, 'to_alipay_dict'):
                params['invoice_create_time'] = self.invoice_create_time.to_alipay_dict()
            else:
                params['invoice_create_time'] = self.invoice_create_time
        ...
        if self.invoice_modified_time:
            if hasattr(self.invoice_modified_time, 'to_alipay_dict'):
                params['invoice_modified_time'] = self.invoice_modified_time.to_alipay_dict()
            else:
                params['invoice_modified_time'] = self.invoice_modified_time
    ...
    def from_alipay_dict(d):
        ...
        if 'invoice_create_time' in d:
            o.invoice_create_time = d['invoice_create_time']
        ...
        if 'invoice_modified_time' in d:
            o.invoice_modified_time = d['invoice_modified_time']

...
class WorkerGetDetailData(object):
        ...
        if self.variables:
            if isinstance(self.variables, list):
                for i in range(0, len(self.variables)):
                    element = self.variables[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.variables[i] = element.to_alipay_dict()
            if hasattr(self.variables, 'to_alipay_dict'):
                params['variables'] = self.variables.to_alipay_dict()
            else:

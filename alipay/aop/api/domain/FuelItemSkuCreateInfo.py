...
from alipay.aop.api.domain.FuelItemExtInfo import FuelItemExtInfo


class FuelItemSkuCreateInfo(object):
    ...
    def ext_info(self, value):
        if isinstance(value, list):
            self._ext_info = list()
            for i in value:
                if isinstance(i, FuelItemExtInfo):
                    self._ext_info.append(i)
                else:
                    self._ext_info.append(FuelItemExtInfo.from_alipay_dict(i))
    @property

...
class AntSignResult(object):

    def __init__(self):
        self._cert_sign_url = None
    ...
    @property
    def cert_sign_url(self):
        return self._cert_sign_url

    @cert_sign_url.setter
    def cert_sign_url(self, value):
        self._cert_sign_url = value
    @property
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.cert_sign_url:
            if hasattr(self.cert_sign_url, 'to_alipay_dict'):
                params['cert_sign_url'] = self.cert_sign_url.to_alipay_dict()
            else:
                params['cert_sign_url'] = self.cert_sign_url
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AntSignResult()
        if 'cert_sign_url' in d:
            o.cert_sign_url = d['cert_sign_url']

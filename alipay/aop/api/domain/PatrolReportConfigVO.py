...
from alipay.aop.api.domain.ReportConfig import ReportConfig


class PatrolReportConfigVO(object):
    ...
    def report_config(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ReportConfig):
                    self._report_config.append(i)
                else:
                    self._report_config.append(ReportConfig.from_alipay_dict(i))
    @property

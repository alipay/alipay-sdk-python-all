...
class AlipayOpenMiniAmpeDevicedataCreateModel(object):
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.device_data:
            if hasattr(self.device_data, 'to_alipay_dict'):
                params['device_data'] = self.device_data.to_alipay_dict()
            else:
                params['device_data'] = self.device_data
        if self.device_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayOpenMiniAmpeDevicedataCreateModel()
        if 'device_data' in d:
            o.device_data = d['device_data']
        if 'device_id' in d:

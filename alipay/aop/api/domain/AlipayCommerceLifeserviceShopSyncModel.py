...
class AlipayCommerceLifeserviceShopSyncModel(object):
    ...
    def to_alipay_dict(self):
        ...
        if self.shop_attrs:
            if isinstance(self.shop_attrs, list):
                for i in range(0, len(self.shop_attrs)):
                    element = self.shop_attrs[i]
                    if hasattr(element, 'to_alipay_dict'):
                        self.shop_attrs[i] = element.to_alipay_dict()
            if hasattr(self.shop_attrs, 'to_alipay_dict'):
                params['shop_attrs'] = self.shop_attrs.to_alipay_dict()
            else:
                params['shop_attrs'] = self.shop_attrs
        if self.shop_id:
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceLifeserviceShopSyncModel()

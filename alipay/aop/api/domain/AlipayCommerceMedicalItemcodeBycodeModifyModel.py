...
from alipay.aop.api.domain.ItemCodeUpdateByCodeVO import ItemCodeUpdateByCodeVO


class AlipayCommerceMedicalItemcodeBycodeModifyModel(object):
    ...
    def item_code_data(self, value):
        if isinstance(value, list):
            ...
            for i in value:
                if isinstance(i, ItemCodeUpdateByCodeVO):
                    self._item_code_data.append(i)
                else:
                    self._item_code_data.append(ItemCodeUpdateByCodeVO.from_alipay_dict(i))
    @property
    def store_code(self):
    ...
    def from_alipay_dict(d):
        if not d:
            return None
        o = AlipayCommerceMedicalItemcodeBycodeModifyModel()

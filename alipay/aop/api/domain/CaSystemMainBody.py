...
from alipay.aop.api.domain.DateTabs import DateTabs


class CaSystemMainBody(object):
    ...
    def __init__(self):
        ...
        self._kw_index = None
        self._kw_shift_x = None
        self._kw_shift_y = None
    ...
    @date_tabs.setter
    def date_tabs(self, value):
        if isinstance(value, DateTabs):
            self._date_tabs = value
        else:
            self._date_tabs = DateTabs.from_alipay_dict(value)
    @property
    def key_word(self):
    ...
    @property
    def kw_shift_x(self):
        return self._kw_shift_x

    @kw_shift_x.setter
    def kw_shift_x(self, value):
        self._kw_shift_x = value
    @property
    def kw_shift_y(self):
        return self._kw_shift_y

    @kw_shift_y.setter
    def kw_shift_y(self, value):
        self._kw_shift_y = value
    @property
    ...
    def to_alipay_dict(self):
        params = dict()
        if self.date_tabs:
            if hasattr(self.date_tabs, 'to_alipay_dict'):
                params['date_tabs'] = self.date_tabs.to_alipay_dict()
            else:
                params['date_tabs'] = self.date_tabs
        if self.key_word:
        ...
        if self.kw_shift_x:
            if hasattr(self.kw_shift_x, 'to_alipay_dict'):
                params['kw_shift_x'] = self.kw_shift_x.to_alipay_dict()
            else:
                params['kw_shift_x'] = self.kw_shift_x
        if self.kw_shift_y:
            if hasattr(self.kw_shift_y, 'to_alipay_dict'):
                params['kw_shift_y'] = self.kw_shift_y.to_alipay_dict()
            else:
                params['kw_shift_y'] = self.kw_shift_y
    ...
    def from_alipay_dict(d):
        ...
        if 'kw_shift_x' in d:
            o.kw_shift_x = d['kw_shift_x']
        if 'kw_shift_y' in d:
            o.kw_shift_y = d['kw_shift_y']

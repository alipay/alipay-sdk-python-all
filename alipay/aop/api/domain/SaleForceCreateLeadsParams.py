...
class SaleForceCreateLeadsParams(object):
    ...
    def __init__(self):
        ...
        self._crm_customer_industry_id = None
        ...
        self._sign_probability_year = None
        self._site = None
    ...
    @property
    def crm_customer_industry_id(self):
        return self._crm_customer_industry_id

    @crm_customer_industry_id.setter
    def crm_customer_industry_id(self, value):
        self._crm_customer_industry_id = value
    @property
    ...
    @property
    def obg_leads_code(self):
        return self._obg_leads_code

    @obg_leads_code.setter
    def obg_leads_code(self, value):
        self._obg_leads_code = value
    @property
    ...
    @salesforce_phase.setter
    def salesforce_phase(self, value):
        self._salesforce_phase = value
    @property
    def sign_path(self):
    ...
    @property
    def sign_probability_year(self):
        return self._sign_probability_year

    @sign_probability_year.setter
    def sign_probability_year(self, value):
        self._sign_probability_year = value
    @property
    def site(self):
        return self._site
    ...
    def to_alipay_dict(self):
        ...
        if self.crm_customer_industry_id:
            if hasattr(self.crm_customer_industry_id, 'to_alipay_dict'):
                params['crm_customer_industry_id'] = self.crm_customer_industry_id.to_alipay_dict()
            else:
                params['crm_customer_industry_id'] = self.crm_customer_industry_id
        ...
        if self.obg_leads_code:
            if hasattr(self.obg_leads_code, 'to_alipay_dict'):
                params['obg_leads_code'] = self.obg_leads_code.to_alipay_dict()
            else:
                params['obg_leads_code'] = self.obg_leads_code
        ...
        if self.salesforce_phase:
            if hasattr(self.salesforce_phase, 'to_alipay_dict'):
                ...
                params['salesforce_phase'] = self.salesforce_phase
        if self.sign_path:
        ...
        if self.sign_probability_year:
            if hasattr(self.sign_probability_year, 'to_alipay_dict'):
                params['sign_probability_year'] = self.sign_probability_year.to_alipay_dict()
            else:
                params['sign_probability_year'] = self.sign_probability_year
        if self.site:
    ...
    def from_alipay_dict(d):
        ...
        if 'crm_customer_industry_id' in d:
            o.crm_customer_industry_id = d['crm_customer_industry_id']
        ...
        if 'obg_leads_code' in d:
            o.obg_leads_code = d['obg_leads_code']
        ...
        if 'sign_probability_year' in d:
            o.sign_probability_year = d['sign_probability_year']
        if 'site' in d:
            o.site = d['site']

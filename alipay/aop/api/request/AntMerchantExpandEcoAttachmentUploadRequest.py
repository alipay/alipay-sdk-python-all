...
class AntMerchantExpandEcoAttachmentUploadRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'ant.merchant.expand.eco.attachment.upload'
        ...
        if self.busi_platform:
            if hasattr(self.busi_platform, 'to_alipay_dict'):
                params['busi_platform'] = json.dumps(obj=self.busi_platform.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.out_order_id:
            if hasattr(self.out_order_id, 'to_alipay_dict'):
                params['out_order_id'] = json.dumps(obj=self.out_order_id.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:

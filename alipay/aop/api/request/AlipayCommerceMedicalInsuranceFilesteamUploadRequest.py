...
class AlipayCommerceMedicalInsuranceFilesteamUploadRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.commerce.medical.insurance.filesteam.upload'
        ...
        if self.channel:
            if hasattr(self.channel, 'to_alipay_dict'):
                params['channel'] = json.dumps(obj=self.channel.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.scene_type:
            if hasattr(self.scene_type, 'to_alipay_dict'):
                params['scene_type'] = json.dumps(obj=self.scene_type.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:

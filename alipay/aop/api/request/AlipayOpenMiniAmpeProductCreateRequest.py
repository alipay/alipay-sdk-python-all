...
class AlipayOpenMiniAmpeProductCreateRequest(object):
    ...
    def get_params(self):
        params = dict()
        params[P_METHOD] = 'alipay.open.mini.ampe.product.create'
        params[P_VERSION] = self.version
        if self.biz_model:
            params[P_BIZ_CONTENT] = json.dumps(obj=self.biz_model.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
        if self.category_id:
            if hasattr(self.category_id, 'to_alipay_dict'):
                params['category_id'] = json.dumps(obj=self.category_id.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.product_name:
            if hasattr(self.product_name, 'to_alipay_dict'):
                params['product_name'] = json.dumps(obj=self.product_name.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
        ...
        if self.ship_quantity:
            if hasattr(self.ship_quantity, 'to_alipay_dict'):
                params['ship_quantity'] = json.dumps(obj=self.ship_quantity.to_alipay_dict(), ensure_ascii=False, sort_keys=True, separators=(',', ':'))
            else:
    ...
    def get_multipart_params(self):
        ...
        if self.product_pic:
            multipart_params['product_pic'] = self.product_pic
